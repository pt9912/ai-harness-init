...
# rueckwirkend auf ALLE Kandidaten, nicht nur auf einen einzelnen. `docs-check` selbst faerbt
# darauf jede Notiz rot, die eine der genannten Phrasen traegt, ohne dass eine Substanz-Aussage
# dahintersteht; dieser Waechter haelt die Nicht-Besetzung ohne einen Docker-Lauf.
set -euo pipefail
