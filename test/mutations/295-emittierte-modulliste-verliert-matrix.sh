...
#
# Entfernt "matrix" aus der emittierten modules:-Liste (slice-073): der Waechter bindet
# genau [links, anchors, ids, matrix, spans], nicht "mindestens zwei Module" — ohne matrix
