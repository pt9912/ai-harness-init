...
# verify: test-go
#
# TRENNT PRUEFUNG UND MELDUNG IN gateTabellenZeileBefund IN ZWEI UNABHAENGIGE LITERALE:
# die PRUEFUNG verlangt "KEIN GATE" (Grossschreibung), die MELDUNG nennt weiterhin
# keinGateMarke ("kein Gate", klein). Eine Gate-Tabellen-Zeile,
