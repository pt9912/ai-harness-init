#!/usr/bin/env bash
# files: cmd/ai-harness-init/span_emit.go
# expect: TestClampSurvivesBrokenPayload
#
# Laesst den Schreiber auf STDOUT schreiben.
#
# ADR-0011 Festlegung 6 setzt zwei Eigenschaften: Exit 0 UND stumme Ausgabe. Fall 107
# deckt nur die erste — er laesst den Schreiber ueber den Panic-Pfad enden, und dessen
# Ausgabe geht auf stderr; die stdout-Zusicherung kann dort gar nicht feuern. Der
# Kommentar im Schreiber behauptete trotzdem, 107 bewache "beides" (Review-Befund
