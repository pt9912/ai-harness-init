...
# nicht ausfuehrbar. Rot faerbt der Fall, dessen docker-Stub mit 1, 3, 125, 127, 137 und 143
# endet und Exit 2, die Meldung des Transports und die Exit-Zeile liest.
set -euo pipefail
