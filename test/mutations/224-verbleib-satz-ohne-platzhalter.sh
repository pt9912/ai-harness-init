#!/usr/bin/env bash
# files: .harness/baseline/v6.5.0/templates/docs/plan/planning/archiv-stub-slice.template.md
...
sed -i 's|docs/plan/planning/done/<welle-id>/|docs/plan/planning/done/|' \
	.harness/baseline/v6.5.0/templates/docs/plan/planning/archiv-stub-slice.template.md
