...
(`.harness/baseline/v6.8.0/templates/docs/plan/planning/welle-results.template.md:1`) und bleiben
...
Regelwerk (`.harness/baseline/v6.8.0/regelwerk/modul-06-roadmap.md` §Wellen-Closure-Prozedur
