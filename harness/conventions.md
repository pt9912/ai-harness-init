...
| [MR-064](conventions/MR-064-d-check-pin-v0761-vcs-bricht-bei-unlesbarem-objekt-ab.md) <a id="mr-064"></a><a id="mr-064--d-check-pin-v0761-vcs-bricht-bei-unlesbarem-objekt-ab"></a> | d-check-Pin v0.76.1 (vcs bricht bei unlesbarem Objekt ab) | `d-check.mk` (`DCHECK_IMAGE`/`DCHECK_DIGEST`, Kopfkommentar), `internal/emit/emit.go` (emittierter Default-Pin), … | keine. Nach dem Wortlaut der Eintrags-Vorlage ist der Eintrag damit ein **Fork**, … |
