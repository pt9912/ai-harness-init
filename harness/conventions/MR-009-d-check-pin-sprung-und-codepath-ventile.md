...
- **Ersetzt-Baseline-Regel:** keine — nach dem Wortlaut der Eintrags-Vorlage damit ein **Fork**.
  ...
  [`modul-14-docker-harness.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-14-docker-harness.md#multi-stage-build-die-operativen-disziplinen-modul-14)
  verlangt (*„Update = bewusster Commit, der nur die Digest-Zeile anhebt"*), und die Neu-Erzeugung
  bei jedem Bump steht in
  [`modul-02-harness-bootstrap.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-02-harness-bootstrap.md#gate-fragment-d-checkmk-schritt-2)
  ...
  [`grundlagen-harness-dateien.md`](../../.harness/baseline/v6.8.0/regelwerk/grundlagen-harness-dateien.md#jedes-artefakt-hat-einen-konsumenten)
