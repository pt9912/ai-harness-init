...
- **Ersetzt-Baseline-Regel:**
  [`modul-14-docker-harness.md`](../../.harness/baseline/v6.5.0/regelwerk/modul-14-docker-harness.md#der-prüflauf-ist-hermetisch--kein-mount)
...
- **Adaption.** Wo das Werkzeug in einem fremden, digest-gepinnten Bild liegt und der Prüfbereich
  ...
  `:ro`-Zweig, den
  [`modul-14-docker-harness.md`](../../.harness/baseline/v6.5.0/regelwerk/modul-14-docker-harness.md#besitz-der-belege-eines-containerisierten-gates)
