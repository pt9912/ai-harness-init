...
- **Ersetzt-Baseline-Regel:** keine — nach dem Wortlaut der Eintrags-Vorlage damit ein **Fork**,
  ...
  [`grundlagen-referenz-richtung.md`](../../.harness/baseline/v6.8.0/regelwerk/grundlagen-referenz-richtung.md#spec-straten-mehr-als-ein-spec-dokument)
  ...
  [`modul-03-spec.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-03-spec.md#ziel-form-spezifikation)
...
- **Adaption:** Das Repo führt das **Technik-Stratum**. `spec/spezifikation.md` steht als
  ...
  ([`grundlagen-referenz-richtung.md` §Spec-Straten](../../.harness/baseline/v6.8.0/regelwerk/grundlagen-referenz-richtung.md#spec-straten-mehr-als-ein-spec-dokument))
...
- **Form des Gefäßes.** Die Abschnittsnummern sind die der vendored Vorlage
  ...
  [`modul-15-observability.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-15-observability.md)
