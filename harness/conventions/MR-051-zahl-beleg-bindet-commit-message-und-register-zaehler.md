...
- **Ersetzt-Baseline-Regel:** keine — nach dem Wortlaut der Eintrags-Vorlage damit ein **Fork**,
  ...
  ([`grundlagen-begriffe.md`](../../.harness/baseline/v6.8.0/regelwerk/grundlagen-begriffe.md#kernbegriffe));
...
- **Setzung 2 — ein Zähler-Stand des Beobachtungs-Registers ist eine datierte Messung, kein Wert
  ...
  **keinen** Erwartungswert und zieht die Schwellen-Folgerung aus dem Lauf statt aus dem
  ...
  [`modul-05-planning-harness.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-05-planning-harness.md#zwei-schritte-vor-der-modus-begründung)
  ...
  **Das ist eine Anwendung, keine zweite Fassung.**
  ...
  [`modul-06-roadmap.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-06-roadmap.md#das-beobachtungs-register-modul-6)
