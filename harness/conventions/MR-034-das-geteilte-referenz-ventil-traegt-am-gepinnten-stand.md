...
> **ÜBERHOLT: der Schlusssatz ihrer Fortgeltung *„Wo der lebende Pin steht, sagt §Baseline."* → [`MR-070`](../conventions.md#mr-070--die-baseline-trägt-den-pin-nicht-als-kopie--der-zustand-steht-am-ort-des-gegenstands).** Die übrige Marke bleibt und zeigt weiter auf [`MR-053`](../conventions.md#mr-053--ein-eintrag-datiert-seine-werkzeug-aussage-statt-den-lebenden-pin-zu-führen); wo der lebende Pin steht, tragen die Geltungsbereiche der Pin-Einträge und `d-check.mk` selbst.
