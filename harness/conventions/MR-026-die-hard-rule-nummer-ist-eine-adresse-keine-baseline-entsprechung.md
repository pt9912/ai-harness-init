...
- **Ersetzt-Baseline-Regel:** keine — nach dem Wortlaut der Eintrags-Vorlage damit ein **Fork**,
  ...
  [`modul-09-implementierung.md`](../../.harness/baseline/v6.5.0/regelwerk/modul-09-implementierung.md#hard-rules-repo-spezifisch)
  ...
  [`grundlagen-traceability.md`](../../.harness/baseline/v6.5.0/regelwerk/grundlagen-traceability.md#herkunfts-anker)),
