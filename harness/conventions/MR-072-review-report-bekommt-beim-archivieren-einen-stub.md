...
- **Wirksamkeits-Anlass:** [ADR-0061](../../docs/plan/adr/0061-review-report-bekommt-beim-archivieren-einen-stub.md)
  ...
  Der Bestand widerspricht der Baseline-Annahme messbar: **144** von **345** Report-Dateien sind
  ...
  und der erste Archiv-Lauf (`archive-welle --vorschau welle-13`) meldet **44** `[haenger]`-Fundstellen,
...
- **Begründung:** Die Baseline-Annahme *„niemand zeigt einzeln auf einen Report"* trägt in diesem
  Repo nicht — 122 der 144 Fundstellen sind Report-zu-Report-Verweise, bereits von
  ...
  nimmt. Ein Stub am unveränderten Pfad löst **alle** 44 Hänger-Fundstellen des Report-Anteils, ohne
  einen der 144 bestehenden Verweise anzufassen — auch die neun in `Accepted`-ADRs, einem
  aufgelösten Carveout, einem append-only-Konventionseintrag, einer eingefrorenen Evidence-Datei
  und `spec/lastenheft.md` bleiben unberührt, weil nichts nachgezogen werden muss. Die Alternativen
