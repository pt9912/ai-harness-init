...
- **Der Ausgang ist *Bezug entfallen*, nicht *gegenstandslos* — und die zwei sind verschieden.**
  [`modul-02-harness-bootstrap.md`](../../.harness/baseline/v6.8.0/regelwerk/modul-02-harness-bootstrap.md#freshness-audit-der-vendored-baseline-schritt-2)
...
- **Gemessen, nicht vermutet — an drei Stellen, nicht am Thema.** Der Kurzschluss, den
  ...
  2. Der Abschnitt, der ihn trug, nennt **keinen Ort** mehr:
     [`grundlagen-durchsetzungsschicht.md`](../../.harness/baseline/v6.8.0/regelwerk/grundlagen-durchsetzungsschicht.md#das-vollständige-artefakt-set)
  ...
  3. Kein anderer Abschnitt springt ein:
     [`grundlagen-harness-dateien.md`](../../.harness/baseline/v6.8.0/regelwerk/grundlagen-harness-dateien.md#verzeichniskonvention)
