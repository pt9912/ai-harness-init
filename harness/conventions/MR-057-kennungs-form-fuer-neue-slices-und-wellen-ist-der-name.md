...
- **Ersetzt-Baseline-Regel:** keine — und nach dem Wortlaut der Eintrags-Vorlage trotzdem **kein
  ...
  neben anderen.
  [`grundlagen-source-precedence.md`](../../.harness/baseline/v6.7.2/regelwerk/grundlagen-source-precedence.md#vergabe-woher-die-nächste-kennung-kommt)
  ...
  `harness/conventions.md`"*. Gemessen am adoptierten Stand `v6.7.2`, weil
  ...
  ```sh
  B=.harness/baseline/v6.7.2/regelwerk/grundlagen-source-precedence.md
...
- **Kein Wächter, und die Baseline sagt es selbst.** §Vergabe schließt mit *„Kein Sensor.
  ...
  (`grep -c 'Doppelvergabe ist heute ein Review-Griff' .harness/baseline/v6.7.2/regelwerk/grundlagen-source-precedence.md`
