...
- **Ersetzt-Baseline-Regel:** keine — nach dem Wortlaut der Eintrags-Vorlage damit ein **Fork**,
  ...
  [`modul-07-carveouts.md`](../../.harness/baseline/v6.9.0/regelwerk/modul-07-carveouts.md#werkzeug-wahl)
  ...
  **Was hier ausdrücklich nicht als ersetzte Regel gilt:** der Formcheck-Satz des
  [Freshness-Audits](../../.harness/baseline/v6.9.0/regelwerk/modul-02-harness-bootstrap.md#freshness-audit-der-vendored-baseline-schritt-2)
...
- **Warum ein neuer Eintrag und keine Korrektur in
  ...
  *„Rückbau ist ein neuer Eintrag, kein Edit — eine aufgelöste `MR-<NNN>` wird nicht
  ...
  damaligen Zustand"*
  ([`modul-02-harness-bootstrap.md`](../../.harness/baseline/v6.9.0/regelwerk/modul-02-harness-bootstrap.md)).
