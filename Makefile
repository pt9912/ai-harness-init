...
TRAEGER_TAG ?= v0.2.4
TRAEGER_SHA256_LINUX_AMD64 ?= dd7a2c792d17051087062d92e4c024f6003150d9f48d12e43746a996e8d88a8e
TRAEGER_SHA256_LINUX_ARM64 ?= e5d30669a1654c9d0168b5047ddc1d60bcee919df459b7d2b21bead5f28d6d36
TRAEGER_SHA256_DARWIN_AMD64 ?= 915ad5fca9491e6ac19e94d2513a21d479d3966a5eed1106147096ec15d270f4
TRAEGER_SHA256_DARWIN_ARM64 ?= fe6891e23b4dacc25dd3abf3bac247796263ce4a76b0ec543c9ff6f7f507687a
TRAEGER_SHA256_WINDOWS_AMD64 ?= 29d8e81efde3aa708a17d7053644ccd6c21924d0d251a129d4c274d93dff1a75
TRAEGER_SHA256_WINDOWS_ARM64 ?= 0f48a82e2b34a7070e95c5317d2d71372d871d11fd73e19a530f5a1aa780397c
...
# `doc-commits` des Fragments d-check.mk; das Kommando gibt dann nichts aus (Exit 0);
# sonst (Exit 1) nennt diff jeden abweichenden Namen in einer `<`- oder `>`-Zeile,
# dazu Hunk-Koepfe und Trenner:
...
# aus (Exit 0); sonst (Exit 1) nennt diff jeden abweichenden Namen in einer `<`- oder
...
# mit 2. Die Klasse des Skripts steht in der letzten stderr-Zeile DES SKRIPTS
# "tap-check: Exit <N>" (bei Exit 0 fehlt sie) und ist der Vertrag; die Meldung von make
# nennt sie ebenfalls als Ziffer, ihr Wortlaut haengt an der Locale und sie ist keiner.
...
# Prozess-Exit ist 128 plus die Signalnummer, wenn das Signal das Skript im Direktaufruf oder
# make selbst trifft, und 2, wenn es das Skript unter make trifft; keine der drei Klassen.
# Bei nicht beschreibbarer stderr ist auch die Klasse nicht zugesagt: ein Formel-Unterschied
# kann als Klasse 2 enden. Lesend, Transport im gepinnten Bild;
