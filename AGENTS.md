...
| `make span-check` | Der Emitter ist vorhanden **und** erzeugt für eine synthetische Payload einen Span, dessen Ablageort `git check-ignore` bestätigt (Schema: [`spec/spezifikation.md`](spec/spezifikation.md#5-metriken-und-tracing-felder) §5) |
