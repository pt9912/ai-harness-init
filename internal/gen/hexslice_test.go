...
func TestGenerate_GoHexsliceProfile_FileSet(t *testing.T) {
	...
	want := []string{
		...
		"cmd/app/main.go",
		"go.mod",
		"internal/adapters/driven/memory/example/repository.go",
		"internal/adapters/driven/notify/stdout.go",
		"internal/adapters/driving/cli/example/cli.go",
		"internal/hexagon/application/example/greet/handler.go",
		"internal/hexagon/application/example/greet/handler_test.go",
		"internal/hexagon/application/example/greet/ports/inbound/greet.go",
		"internal/hexagon/application/example/greet/ports/outbound/notifier.go",
		"internal/hexagon/application/example/greet/validator.go",
		"internal/hexagon/application/example/ports/outbound/greeting_repository.go",
