...
# ist ein Stolperdraht, keine Sandbox (ADR-0004). Vollständigkeit ist nicht
# das Ziel — bei Unsicherheit lieber blocken (LH-FA-06: fail-closed).
#
# Zeichenweiser Scanner mit Tiefen-/Key-Stack: er unterscheidet JSON-Keys von
# -Values und entschärft so den "command-im-Value"-Fehlmatch. Nur der Pfad
# tool_input -> command (Objekt-Tiefe 2) zählt.
