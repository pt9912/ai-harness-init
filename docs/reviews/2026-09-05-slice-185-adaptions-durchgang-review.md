...
- **befund:** Von allen Baseline-Pfaden im Eintrags-Bestand zeigt genau dieser eine am Zielstand ins
  ...
  ausdrücklich [slice-091](../plan/planning/done/slice-091-vendored-baum-ohne-anspruch.md) und
  [slice-092](../plan/planning/done/slice-092-traeger-inventur.md) zu (§Was dieser Durchgang
...
- **Folge-Slice-Paarung** — jede im Plan genannte Kennung existiert im Lifecycle:
  [slice-091](../plan/planning/done/slice-091-vendored-baum-ohne-anspruch.md),
  [slice-092](../plan/planning/done/slice-092-traeger-inventur.md),
