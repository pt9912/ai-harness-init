...
- `pfad`: `docs/plan/planning/done/slice-129-closure-notiz-hat-einen-sensor.md:104,114,126` (Commit `3b6c81af`, „Rolle Implementer: slice-129 — DoD behauptet, Plan-Tabelle an die getroffene Entscheidung angepasst")
