...
- **pfad:** [`slice-177`](../plan/planning/in-progress/slice-177-beobachtungs-register-verzeichnis-form.md) §2 DoD 3 (Zeilen 182–185), `.gitignore` Zeilen 19–24
...
- **pfad:** [`slice-177`](../plan/planning/in-progress/slice-177-beobachtungs-register-verzeichnis-form.md) Zeile 174 (DoD 2) und Zeilen 333–336 (§6, sechstes Risiko)
...
- **verifizierbar:** ja — `make docs-check` gegen `sed -n '174p;333,336p' docs/plan/planning/in-progress/slice-177-beobachtungs-register-verzeichnis-form.md`.
...
- **pfad:** [`slice-177`](../plan/planning/in-progress/slice-177-beobachtungs-register-verzeichnis-form.md) Zeilen 337–346 (siebtes Risiko)
