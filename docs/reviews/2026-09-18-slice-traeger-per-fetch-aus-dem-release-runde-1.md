...
| F-6 | INFO | Der Plan nennt in §8 „145 Verzeichnisse unter `BEO-ALL/`" ohne das Kommando daneben (`ls -d docs/plan/planning/observations/BEO-ALL/*/ | wc -l` → 145 — die Zahl ist korrekt, die Form fehlt). Kann der Planner im Zug der F-1/F-2-Korrektur nachziehen. | `MR-025` | docs/plan/planning/in-progress/slice-traeger-per-fetch-aus-dem-release.md:327 | ja — das Zählkommando neben der Zahl | Zahl im lebenden Artefakt ohne Kommando daneben |
