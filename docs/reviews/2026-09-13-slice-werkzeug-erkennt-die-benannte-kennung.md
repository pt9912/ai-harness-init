...
- **befund:** `Hervorgegangen()` trifft die benannte Kennung jetzt und reicht sie per
  ...
  SlicePfadRelativ("188")                                   = "../../done/slice-188-archiv-stub-kennt-die-register-verzeichnis-form.md"
...
- **Punkt 4 — Zuschnitt von `sliceRE`.** Bestätigt. `git grep 'sliceRE'` liefert drei Zeilen
  ...
  zu [slice-188](../plan/planning/done/slice-188-archiv-stub-kennt-die-register-verzeichnis-form.md)
...
- **`beoRE`** und die Register-Kennungsform — Gegenstand von
  [slice-188](../plan/planning/done/slice-188-archiv-stub-kennt-die-register-verzeichnis-form.md).
