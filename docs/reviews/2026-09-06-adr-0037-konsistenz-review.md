...
- **Slice-Plan:** [`slice-190`](../plan/planning/open/slice-190-bootstrap-legt-die-versprochenen-orte-an.md)
...
- `befund`: Die Zeile lautet *„Architect-Lauf zu den zwei offenen Risiken aus `slice-190` §6, die
  ...
  [`slice-190`](../plan/planning/open/slice-190-bootstrap-legt-die-versprochenen-orte-an.md) §6
...
- `verifizierbar`: **nein**. Reproduzierbar:
  ```sh
  sed -n '/^## 6\. Risiken/,/^## 7\./p' \
    docs/plan/planning/open/slice-190-bootstrap-legt-die-versprochenen-orte-an.md \
