...
- **Der Trennungs-Trigger der Entscheidung ist scharf.** Die Messung aus
  ...
  liegt vor ([slice-095](in-progress/slice-095-hook-aufschlag-gemessen.md)), mit ihrem Kommando im Text.
...
| [slice-095](in-progress/slice-095-hook-aufschlag-gemessen.md) | Der Aufschlag je Tool-Call ist gemessen, und der Trennungs-Trigger kann feuern | [`ADR-0011`](../adr/0011-telemetrie-erfassung-policy.md) |
...
**Danach [slice-095](in-progress/slice-095-hook-aufschlag-gemessen.md), und diese Stelle ist eine
