...
- [`ADR-0006`](../../../docs/plan/adr/0006-durchsetzung-commands-tool-als-quelle.md) accepted (erfüllt) — Picker → Tool-als-Quelle entsperrt die
  Emission **ohne** Kurs-Upstream-Warten. **Beobachtbar**: ohne die ADR fehlte die Quelle.
...
| Slice | Titel | Bezug |
|---|---|---|
| [slice-030](open/slice-030-durchsetzung-skills-emit.md) | Reviewer-/Closure-Skill emittieren (`.harness/skills/`, Fetch — Emit-Pfad de-risken) | [`LH-FA-06`](../../../spec/lastenheft.md#lh-fa-06--durchsetzungsschicht-emittieren) |
