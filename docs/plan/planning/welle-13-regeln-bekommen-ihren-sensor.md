...
Planungs-Akts, der diese Welle eröffnet, nicht dieser Notiz.** [slice-187](done/slice-187-d-check-pin-v0741.md)
(wellenlos) zieht den d-check-Pin von `v0.65.0` — der Stand, gegen den §1 dieser Welle
