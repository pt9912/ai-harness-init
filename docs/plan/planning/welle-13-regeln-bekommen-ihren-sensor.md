...
2. **Die Adoptions-Schuld ist real und je Modul verschieden** — jede Zahl aus dem Lauf des
   ...
   **Alle diese Zahlen hängen an ihrem Stand und sind keine Erwartungswerte**
   ...
   Ein Sensor nach [slice-125](open/slice-125-roadmap-und-verzeichnis-stimmen-ueberein.md) muss
...
| Slice | Titel | Bezug |
|---|---|---|
| [slice-123](in-progress/slice-123-ci-sieht-die-historie.md) | CI sieht die Historie — oder der Lauf fällt, statt grün zu melden | [`LH-QA-02`](../../../spec/lastenheft.md#lh-qa-02--reproduzierbarkeit) |
...
[slice-123](in-progress/slice-123-ci-sieht-die-historie.md) geht **[slice-126](open/slice-126-commit-message-traegt-eine-kennung.md)
...
- **`planning.observations` — die vierte Fähigkeit desselben Moduls, neu in der Spanne, und sie
  ...
  **Warum sie trotzdem draußen bleibt:** Sie ist keine der gemessenen Achsen des Kandidaten, aus
  ...
  `planning`-Schlüsselbaum neben [slice-125](open/slice-125-roadmap-und-verzeichnis-stimmen-ueberein.md)
