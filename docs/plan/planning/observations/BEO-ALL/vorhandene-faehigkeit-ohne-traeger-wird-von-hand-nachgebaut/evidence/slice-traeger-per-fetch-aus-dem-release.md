...
Traeger (gitignorierter Zustaands-Bereich, [`ADR-0022`](../../../../../adr/0022-erfassungsschicht-traeger-aus-dem-produkt-binaer.md) Festlegung 5(b)), und der
...
`make traeger-fetch` (Fragment, emittiert ins Ziel als harness/mk/traeger.mk, kein Prerequisite,
nichts an `GATE_CHECKS` — [`ADR-0058`](../../../../../adr/0058-traeger-per-fetch-aus-dem-gepinnten-release.md) Festlegung 3) ist der Einstieg, und die
