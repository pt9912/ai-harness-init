...
(`grep -rnI --exclude-dir=.git --exclude-dir=.harness -E 'slice-archive-welle-schreibt-in-reports-nur-die-link-form\.md|(open|next|in-progress|done)/slice-archive-welle-schreibt-in-reports-nur-die-link-form|\]\(slice-archive-welle-schreibt-in-reports-nur-die-link-form' . | grep -v 'planning/next/slice-archive-welle-schreibt-in-reports-nur-die-link-form.md' | wc -l`
