...
[`grundlagen-harness-dateien.md` §harness/conventions.md als Konventionsspeicher](../../../../.harness/baseline/v6.9.0/regelwerk/grundlagen-harness-dateien.md#harnessconventionsmd-als-konventionsspeicher)),
...
Ausfüll-Vorlage unter `.harness/baseline/v6.9.0/templates/harness/sensors/`. Die drei Ablageorte,
