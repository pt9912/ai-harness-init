...
[slice-186](next/slice-186-beobachtungs-kennungen-loesen-wieder-auf.md) §1). Ein Katalog ordnet
...
- **Vier Kanten innerhalb der Welle sind tragend, eine ist ordnend.** Tragend:
  ...
  [slice-177](done/slice-177-beobachtungs-register-verzeichnis-form.md) →
  [slice-186](next/slice-186-beobachtungs-kennungen-loesen-wieder-auf.md) — die vierte tragende
