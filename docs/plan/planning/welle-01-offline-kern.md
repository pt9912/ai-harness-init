...
|---|---|---|---|
| [slice-001a](in-progress/slice-001a-cli-skeleton.md) | CLI-Skeleton (Go) + go-test-Gate | in-progress | [`LH-FA-01`](../../../spec/lastenheft.md#lh-fa-01--repo-bootstrappen), [`LH-QA-03`](../../../spec/lastenheft.md#lh-qa-03--minimale-abhängigkeiten) |
