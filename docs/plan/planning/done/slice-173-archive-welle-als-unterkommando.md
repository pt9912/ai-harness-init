...
[slice-175](../in-progress/slice-175-archive-welle-schreibender-pfad.md).
...
[slice-175](../in-progress/slice-175-archive-welle-schreibender-pfad.md) sein einziger.
...
- [x] **Die zwei lesenden Abnahme-Kriterien halten, je einmal rot gesehen** —
      ...
      [slice-175](../in-progress/slice-175-archive-welle-schreibender-pfad.md); Folgepflicht 1 jener ADR
...
- **Ein Port erbt die Grenzen des Vorbilds.** Dessen `README.md` §Grenzen nennt selbst, dass ein
  ...
  nicht meldet, wandert ungesehen durch [slice-175](../in-progress/slice-175-archive-welle-schreibender-pfad.md).
...
- **Folge-Slices:** [slice-175](../in-progress/slice-175-archive-welle-schreibender-pfad.md) (schreibender
