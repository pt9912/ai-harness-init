...
- **Zwei Abweichungen sind durch den Modul-7-Trichter nicht gelaufen.** Der Eintrag sagt es selbst:
  ...
  [slice-068](slice-068-rollen-arbeit-laeuft-als-rolle.md) benannte Träger; 5 trägt eine
  ...
  Abdeckungszahl aus [slice-066](slice-066-telemetrie-auswertung.md) DoD (1) — wie viele
