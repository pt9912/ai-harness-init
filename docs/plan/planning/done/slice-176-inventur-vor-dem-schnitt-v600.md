...
- **Der Bestand offener Slice-Pläne wird von diesem Katalog nicht gehalten** (`BEO-023`). Er misst
  ...
  [slice-184](../open/slice-184-register-form-im-bestand-nachziehen.md), Welle-Mitglied; Register
...
- **Übergabe 1 an den Architect: die regierende Fassung dieses Sprungs — Träger ist
  ...
  Der Träger [slice-178](../open/slice-178-regierende-fassung-des-sprungs-v600.md) liegt in `open/`
...
| P-02 | `grundlagen-begriffe.md` ×1 · `modul-05` H2 | Kennung: `BEO-<NNN>` → `BEO-<KUERZEL>/<slug>`; **keine Vergabestelle, keine fortlaufende Nummer** | RE | entschieden in [`ADR-0034`](../../adr/0034-register-verzeichnis-form-und-die-ortsfestigkeit-der-register-datei.md) Festlegung 3, vollzogen von [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) — **kein neuer Slice** |
| P-03 | `grundlagen-harness-dateien.md` H1 | Planning-Layout: `observations.md` → `observations/` | RE | [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) |
...
| P-09 | `modul-06` H3 | **§Das Beobachtungs-Register vollständig neu**: Verzeichnis statt Tabelle · drei Dateien mit drei Lebensdauern · **Zähler abgeleitet statt geführt** · Kennung **ist** der Pfad · leere Ablage = nur `README.md` · *gestrichen* wird Verzeichnis-Vermerk statt zweiter Sektion · die Beleg-Prüfungen fallen von **drei** auf **zwei** (die *Anzahl*-Prüfung hat kein Objekt mehr) | RE | [`ADR-0034`](../../adr/0034-register-verzeichnis-form-und-die-ortsfestigkeit-der-register-datei.md) + [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) — **kein neuer Slice** |
| P-10 | `modul-06` H4 | Wellen-Eröffnung Schritt 2 nennt den neuen Registerpfad | RE | [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) DoD 2 |
| P-11 | `modul-06` H5 | Register-Paarung (c): die genannte Beobachtung existiert als **Verzeichnis** statt als Zeile | RE | [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) — dazu die **benannte Lücke**: die maschinelle Hälfte ist hier ohnehin unbewacht (`grep -c observations .d-check.yml` → 0), und das bleibt sie ([`LH-QA-01`](../../../../spec/lastenheft.md#lh-qa-01--keine-halluzinierten-gates-f4-f5-f6)) |
...
| P-13 | `README.template.md` ×1 | Planning-README: das Register liegt als `observations/` neben den Wellen | RE | [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) DoD 2 — `docs/plan/planning/README.md` steht in dessen Bezugsmenge |
| P-14 | `observation.template.md` (**A**, +88) · `observations.template.md` (**D**, −58) | die Ziel-Form **je Beobachtung** entsteht, die Register-Vorlage entfällt | RE | [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) legt daraus per `cp` an; die Vorlage liegt netzlos erst nach [slice-182](../done/slice-182-baum-tausch-v600-pins-ziehen.md) vor — genau die erste Start-Bedingung jenes Slice |
...
[slice-178](../open/slice-178-regierende-fassung-des-sprungs-v600.md), §6 Übergabe 1.
...
[slice-178](../open/slice-178-regierende-fassung-des-sprungs-v600.md) §4 **nicht**.
...
Rückführung, die [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) §4 bereits
vorab benennt.
...
[slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) (der Vollzug); der Katalog
...
[slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md), das erste Pfad-Segment
