...
- **Übergabe 2 an den Architect: die Buchung der Zielstand-Setzung — sie gehört nicht in diesen
  ...
  **Ausgang: entfallen.** Der Baum-Tausch-Slice ist geschnitten:
  [slice-182](../in-progress/slice-182-baum-tausch-v600-pins-ziehen.md) trägt die Buchung als dritten
...
- **Folge-Slices:** [slice-182](../in-progress/slice-182-baum-tausch-v600-pins-ziehen.md),
...
|---|---|---|---|---|
| P-01 | `regelwerk/README.md` ×1 | `Stand:`-Zeile `Kurs-Welle 111 · 2026-08-31` → `116 · 2026-09-03` | RE | [slice-182](../in-progress/slice-182-baum-tausch-v600-pins-ziehen.md) — §Baseline von [`harness/conventions.md`](../../../../harness/conventions.md) zitiert genau diese Zeile per `sed -n '3p'` |
...
| P-14 | `observation.template.md` (**A**, +88) · `observations.template.md` (**D**, −58) | die Ziel-Form **je Beobachtung** entsteht, die Register-Vorlage entfällt | RE | [slice-177](../open/slice-177-beobachtungs-register-verzeichnis-form.md) legt daraus per `cp` an; die Vorlage liegt netzlos erst nach [slice-182](../in-progress/slice-182-baum-tausch-v600-pins-ziehen.md) vor — genau die erste Start-Bedingung jenes Slice |
...
[slice-182](../in-progress/slice-182-baum-tausch-v600-pins-ziehen.md) §6, Risiko 1 und 2. Und sein
