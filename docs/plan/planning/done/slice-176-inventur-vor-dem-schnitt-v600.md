...
- **Ein Delta-Katalog findet eine Deckung nicht, die ein Volltext-Durchgang fände** (`BEO-013`).
  ...
  [slice-185](../done/slice-185-adaptions-durchgang-gegen-v600.md) ist geschnitten, und seine
...
- **Der Bestand offener Slice-Pläne wird von diesem Katalog nicht gehalten** (`BEO-023`). Er misst
  ...
  [slice-184](../done/slice-184-register-form-im-bestand-nachziehen.md), Welle-Mitglied; Register
...
- **Folge-Slices:** [slice-182](../done/slice-182-baum-tausch-v600-pins-ziehen.md),
  ...
  [welle-15](welle-15-re-baseline.md); [slice-183](../next/slice-183-ausloeser-der-wellenlosen-archivierung.md)
...
| P-15 | `slice.template.md` ×2 | DoD-Zeile und §7-Zeile: Verzeichnis-Ablage, **kein Zähler wird gesetzt** — er folgt aus den Dateien | RE **+ EM** | **neu:** [slice-184](../done/slice-184-register-form-im-bestand-nachziehen.md). Gemessen: **10** von **60** lebenden Plänen tragen die alte DoD-Zeile, **4** Anweisungssatz-Dateien die alte Form-Beschreibung (Kommandos in dessen §1) |
...
[slice-185](../done/slice-185-adaptions-durchgang-gegen-v600.md), dessen DoD 2 die Volltext-Hälfte
...
[slice-183](../next/slice-183-ausloeser-der-wellenlosen-archivierung.md) einen **eigenen
