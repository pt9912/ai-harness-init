...
- [x] Emit-Test belegt die Verdrahtung struktur-seitig (Include vorhanden, Targets aufrufbar). **Der Voll-E2E-Beweis ist ausdrücklich [slice-024](slice-024-voll-smoke.md)** — hier wird er *nicht* behauptet.
- [x] `make gates` grün.
