...
> nach [slice-024](../in-progress/slice-024-voll-smoke.md) (welle-03), weil er den vollständigen
...
- [x] Emit-Test belegt die Verdrahtung struktur-seitig (Include vorhanden, Targets aufrufbar). **Der Voll-E2E-Beweis ist ausdrücklich [slice-024](../in-progress/slice-024-voll-smoke.md)** — hier wird er *nicht* behauptet.
- [x] `make gates` grün.
