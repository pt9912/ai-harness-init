...
- **Folge-Slices:** [slice-156](../done/slice-156-baum-tauschen-pins-ziehen.md) (Tausch und Pins) ·
  ...
  [slice-160](../in-progress/slice-160-docker-form-hermetisch-und-beleg.md) (Docker-Form) ·
...
| 13 | `modul-13-quality-gates.md` | **neu**: §Gate und Beleg — zwei Rollen derselben Prüfung. Der tolerierende Nachsatz gehört an den Beleg-Lauf, **nie** an den Gate-Lauf; die sammelnde Stage erbt von der Quell-, nicht von der Gate-Stage | D+E | [slice-160](../in-progress/slice-160-docker-form-hermetisch-und-beleg.md) |
| 14 | `modul-14-docker-harness.md` | **neu**, drei Abschnitte: §Zwei Formen des Reproduzierbarkeits-Ankers (Archiv vs. Rezept) · §Besitz der Belege eines containerisierten Gates (root über schreibbarem Mount) · §Der Prüflauf ist hermetisch — kein Mount (`COPY` + `stdout`; `--no-cache-filter`, **kein** `-q`) | D+E | [slice-160](../in-progress/slice-160-docker-form-hermetisch-und-beleg.md) |
...
[160](../in-progress/slice-160-docker-form-hermetisch-und-beleg.md) (Docker-Form) ·
