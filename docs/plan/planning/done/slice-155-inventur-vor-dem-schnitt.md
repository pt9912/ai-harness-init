...
- **Folge-Slices:** [slice-156](../done/slice-156-baum-tauschen-pins-ziehen.md) (Tausch und Pins) ·
  ...
  [slice-159](../in-progress/slice-159-register-traegt-die-drei-ausgaenge.md) (Beobachtungs-Register) ·
...
| 19 | `templates/docs/plan/planning/observations.template.md` | Kopftext nennt die drei Ausgänge; Bedienhinweis: Vorgangs-Beleg, ein Vorgang zählt einmal, `offen` als Normalzustand | D | [slice-159](../in-progress/slice-159-register-traegt-die-drei-ausgaenge.md) — Singleton-Form-Pflicht, die zweite Ursachen-Klasse aus `BEO-010` |
...
[159](../in-progress/slice-159-register-traegt-die-drei-ausgaenge.md) (Beobachtungs-Register) ·
