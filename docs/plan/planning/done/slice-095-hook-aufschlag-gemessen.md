...
[slice-096](../next/slice-096-traeger-liegt-im-ziel.md), weil sein Ausgang eine Konstruktions-Eingabe für
...
[slice-096](../next/slice-096-traeger-liegt-im-ziel.md) zu messen, weil sein negativer Ausgang eine benannte
...
- [x] **(2) Der Ausgang ist verbindlich verortet, in beide Richtungen.** Hält die Schwelle: Annahme
      ...
      **nicht** eine höhere Schwelle, sondern Umfang senken oder Einstiegspunkt trennen
      ...
      [slice-096](../next/slice-096-traeger-liegt-im-ziel.md) bis
