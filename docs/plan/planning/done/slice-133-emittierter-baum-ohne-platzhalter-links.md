...
- **`make full-smoke` zieht das Asset aus dem Netz** und ist damit an eine Bedingung außerhalb des
  ...
  *weiter offen* an das **Beobachtungs-Register**, und das Repo führt keines
  ...
  [slice-137](../next/slice-137-beobachtungs-register-bekommt-seinen-ort.md). Bis der läuft, ist
...
[slice-137](../next/slice-137-beobachtungs-register-bekommt-seinen-ort.md) legt das Register an und
...
| Risiko 3 hat keinen gültigen vorformulierten Ausgang | Verifikation `V-1` | **entschieden: weiter offen** (§6), mit dem Register-Träger [slice-137](../next/slice-137-beobachtungs-register-bekommt-seinen-ort.md) |
