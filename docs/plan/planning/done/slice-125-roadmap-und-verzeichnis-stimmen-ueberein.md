...
[slice-129](../in-progress/slice-129-closure-notiz-hat-einen-sensor.md) geschnitten. **Beide Slices konfigurieren
...
- **Folge-Slices: keine geschnitten**, und das ist eine Entscheidung. Zwei der vier Risiken sind
  ...
  [slice-129](../in-progress/slice-129-closure-notiz-hat-einen-sensor.md) bleibt liegen — er konfiguriert
