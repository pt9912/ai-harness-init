...
[slice-126](../in-progress/slice-126-commit-message-traegt-eine-kennung.md) DoD (3) verlangt vom Träger
...
| Rang-Zeiger `d-check.mk:2` nennt keinen Eintrag für `v0.65.0` | Review LOW-1 | **[slice-128](../done/slice-128-d-check-kopf-sagt-was-gilt.md)** DoD (1) — mit dem Beginn-Trigger *„der Eintrag existiert"*; echte Reihenfolge-Abhängigkeit |
