...
- [x] **(1) Jedes `docs?-*`-Ziel ist klassifiziert, und die C-Klasse ist an einem eingesetzten
      ...
      [slice-114](../next/slice-114-jede-aussage-hat-einen-abschnitt.md) hergestellt hat, während dieser
...
- **Was ging anders als geplant:** Drei Dinge. **Erstens** hat ein gleichzeitig laufender Slice der
  ...
  brachte [slice-114](../next/slice-114-jede-aussage-hat-einen-abschnitt.md) dieselbe Datei auf die
