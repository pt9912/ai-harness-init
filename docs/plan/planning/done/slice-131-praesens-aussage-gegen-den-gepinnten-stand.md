...
|---|---|---|
| [slice-090](../done/slice-090-freshness-audit-im-ziel.md), [slice-091](../done/slice-091-vendored-baum-ohne-anspruch.md), [slice-101](../open/slice-101-norm-postens-bekommen-einen-termin.md), [slice-112](../open/slice-112-replay-schritt-hat-keinen-referenten.md) | update | je eine bis zwei Präsens-Aussagen über den vendored Baum; zwei von ihnen bewegen sich nachweislich (§1) |
