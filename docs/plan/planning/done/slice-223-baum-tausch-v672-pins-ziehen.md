...
- **Kein Delta-Urteil über den neuen Stand.** Welche Regel der Fassung `v6.7.2` welches Artefakt
  ...
  Planungs-Ebene) und [slice-225](../done/slice-225-gate-index-steht-einmal.md) (Norm- und
...
- **Folge-Slices:** [slice-224](../done/slice-224-delta-nachweis-und-planungs-nachzug.md)
  ...
  [slice-225](../done/slice-225-gate-index-steht-einmal.md) (Norm- und Gate-Ebene) — beide Dateien
