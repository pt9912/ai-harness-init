...
- **Kein Posten, der in [`AGENTS.md`](../../../../AGENTS.md),
  ...
  Norm-Ebene und liegt bei [slice-225](../done/slice-225-gate-index-steht-einmal.md), dessen §1 sie annimmt.
...
- **Folge-Slices:** keiner geschnitten — das ist Planner-Arbeit. **Ein Zwilling wird frei:**
  [slice-lifecycle-move-geht-ins-ziel](../in-progress/slice-lifecycle-move-geht-ins-ziel.md) liegt in
