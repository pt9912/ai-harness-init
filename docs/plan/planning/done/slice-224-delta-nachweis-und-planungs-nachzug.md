...
2. **Aus diesem Durchgang entsteht kein neuer `MR`-Eintrag.** Ein Eintrag bucht eine *gewollte*
   ...
   — das liegt bei [slice-225](../done/slice-225-gate-index-steht-einmal.md), weil der
...
- **Kein Posten, der in `AGENTS.md`, `harness/README.md`, [`.d-check.yml`](../../../../.d-check.yml)
  ...
  [slice-225](../done/slice-225-gate-index-steht-einmal.md) übernimmt sie; dieser Slice **benennt**
...
- [x] **1 — Der Delta-Nachweis liegt vor und ist vollständig.** Alle **42** Posten des Deltas
      ...
      [slice-225](../done/slice-225-gate-index-steht-einmal.md), oder in einem der in §1
...
- [x] **2 — Die lebenden Planungs-Artefakte tragen die neue Ziel-Form.** Prüfbereich ist der
      ...
      **Die Zusage gilt der Verwendung, nicht dem Zitat, und ihr Prüfbereich ist der Bestand
      ...
      [slice-226](../next/slice-226-implementer-anweisungssatz-zieht-nach.md) aufnimmt — und
...
- [x] **3 — Jede Sendung an eine andere Rolle liegt als Übergabe-Artefakt vor.** Für jeden Posten,
      ...
      Norm-/Gate-Posten an [slice-225](../done/slice-225-gate-index-steht-einmal.md), die
...
- **Ein Posten färbt beim Übernehmen ein Gate rot.** Zwei Stellen halte ich dafür für möglich, und
  beide liegen in [slice-225](../done/slice-225-gate-index-steht-einmal.md), nicht hier: der
  ...
  unverändert in [slice-225](../done/slice-225-gate-index-steht-einmal.md) und sind dort §6; sie
...
- **Ein offener Plan in `open/`/`next/` verpflichtet nach dem Sprung anders, und dieser Slice
  ...
  [slice-225](../done/slice-225-gate-index-steht-einmal.md). Der Fall ist genau der beschriebene,
...
- **Der Zuschnitt zwischen diesem Slice und slice-225 ist eine Vorab-Zuordnung.** Er ist nach dem
  **Beleg** geschnitten (Form-Vergleich gegen Gate-Lauf), und der Nachweis kann ergeben, dass ein
  ...
  Folge-Slice [slice-225](../done/slice-225-gate-index-steht-einmal.md). Ein Posten lag tatsächlich
...
- **Zwei Sendungen aus Liefer-Punkt 3 haben keinen terminierten Träger** (Review slice-224
  ...
  den Architect wurde mit demselben Sprung ein Träger geschnitten ([slice-225](../done/slice-225-gate-index-steht-einmal.md));
  ...
  Festlegung 1): [slice-226](../next/slice-226-implementer-anweisungssatz-zieht-nach.md) für den
...
- **Folge-Slices:** [slice-225](../done/slice-225-gate-index-steht-einmal.md) (Der Gate-Index steht
  ...
  DoD-2 nennt sie; [slice-226](../next/slice-226-implementer-anweisungssatz-zieht-nach.md) (Der
...
| `lab/regelwerk/modul-13-quality-gates.md` | 130-131 | übernommen | „Gate-Index steht einmal"-Konzept (Deklarations-Sensor, `kein Gate`-Markierung in der Zeile selbst, Grenzen-Pflicht je Gate) — deckungsgleich mit dem Titel von [slice-225](../done/slice-225-gate-index-steht-einmal.md) | slice-225 |
