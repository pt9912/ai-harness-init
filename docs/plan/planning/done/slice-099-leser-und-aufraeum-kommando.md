...
- **Nicht korrigiert: DoD (1)s Rot-Kommando, obwohl die schmalere Stufe existiert.** Der Punkt
  ...
  Bestand, dessen Kosten [slice-105](../next/slice-105-mutate-messen-dann-teilen.md) misst), keine
