...
[slice-135](../done/slice-135-d-check-pin-v0661.md) als den Slice dieser Linie; dieser hier tritt an
...
[slice-135](../done/slice-135-d-check-pin-v0661.md) liegt in `open/` und zieht den Pin auf **`v0.66.1`** —
...
| [slice-135](../done/slice-135-d-check-pin-v0661.md) | update | Zeiger auf diesen Slice, weil seine Ziel-Version überholt ist und die Linie **einen** lebenden Pin trägt (§1 *Was mit slice-135 geschieht*). Planner-Eigentum, keine fremde Rolle berührt. **Nicht** gelöscht — dafür fehlt die Norm (§6) |
...
- **Ein überholter offener Plan hat keinen Ausgang, den eine Norm nennt.**
  [slice-135](../done/slice-135-d-check-pin-v0661.md) zeigt die Klasse: ein Plan wartet in `open/` über
...
- **Folge-Slices:** **keine geschnitten**, und das ist eine Entscheidung, keine Auslassung. Vier
  ...
  **Anheben** über den Steering-Loop
  ...
  Datei, die es nicht gibt. [slice-135](../done/slice-135-d-check-pin-v0661.md) bleibt liegen —
...
- `BEO-ALL/folge-slice-ueberlebt-baseline-sprung-mit-alter-pflicht` (**2×**, `slice-160`,
  ...
  Sprung ändert die Pflicht, die er halten soll*. [slice-135](../done/slice-135-d-check-pin-v0661.md) ist
