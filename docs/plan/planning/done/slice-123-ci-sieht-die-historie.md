...
[slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md) und
...
das sind, ist nach [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md) und
...
- `in-progress` → `next`: DoD (2) lässt sich nicht entscheiden, weil noch kein history-lesender
  ...
  **hinter** [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md); die Kante dreht sich um.
...
- **Der Wächter kann sich selbst nicht beweisen, solange er allein steht.** Vor
  ...
  **Ausgang: eingetreten → [slice-127](../done/slice-127-adr-immutabilitaet-hat-einen-sensor.md)**
  (nachrangig [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md)). Der Wächter
...
- **`fetch-depth: 0` ist eine Kosten-Entscheidung, die dieser Slice trifft, ohne sie zu messen.**
  ...
  **Ausgang: entfallen** — die Prämisse ist nicht eingetreten. Der Slice setzt `fetch-depth: 0`
  ...
  [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md) entscheidet ausdrücklich,
...
- **Die Zuordnung aus DoD (2) ist über der leeren Menge wahr.** Der erste Punkt oben betrifft die
  *Deckung* des Wächters, dieser die *Zuordnungs-Aussage* daneben: Kein Schritt liest heute Historie
  ...
  [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md) oder
  ...
  **Ausgang: eingetreten → [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md)**
...
- **Folge-Slices:** [slice-126](../done/slice-126-commit-message-traegt-eine-kennung.md) und
