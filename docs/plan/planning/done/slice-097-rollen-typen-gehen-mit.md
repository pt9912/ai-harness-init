...
| `make mutate` kostet **1166** Sekunden für **157** Fälle (Messung der [Verifikation](../../../reviews/2026-08-25-slice-097-verify.md) §1.1, **fremdbelegt**), und sein Grün-Vorlauf wirft sein Protokoll bei Erfolg weg — ein grüner Lauf belegt darum **nicht**, dass die Zähne dieses Slice in `full-smoke` gelaufen sind | **[slice-105](../next/slice-105-mutate-messen-dann-teilen.md)** — er misst zuerst je Fall und je Sensor und entscheidet dann über die Teilung; die Protokoll-Frage hängt an derselben Mechanik |
...
[slice-105](../next/slice-105-mutate-messen-dann-teilen.md) (`make mutate` wird **erst gemessen**,
