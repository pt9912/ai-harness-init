...
- **Folge-Slices:** keiner geschnitten. [slice-173](../done/slice-173-archive-welle-als-unterkommando.md)
  und [slice-174](../in-progress/slice-174-archivierung-emittieren.md) liegen vor diesem Lauf in `open/`
...
[slice-174](../in-progress/slice-174-archivierung-emittieren.md). Weitere Treffer: keine.
