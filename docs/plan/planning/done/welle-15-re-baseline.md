...
[slice-176](slice-176-inventur-vor-dem-schnitt-v600.md): **sieben**, dazu ein
...
([slice-176](slice-176-inventur-vor-dem-schnitt-v600.md) §9, zweistufig); die **Wahl**
ist offen und trägt [slice-178](slice-178-regierende-fassung-des-sprungs-v600.md). Beide
...
der Baum-Tausch von [welle-10](welle-10-re-baseline.md) genau dort brach und für
`make gates` unsichtbar blieb ([slice-133](slice-133-emittierter-baum-ohne-platzhalter-links.md)).
...
| Slice | Titel | Bezug |
|---|---|---|
| [slice-176](slice-176-inventur-vor-dem-schnitt-v600.md) | Inventur vor dem Schnitt — der Form- und Regel-Diff `v5.18.0` → `v6.0.0` | [`LH-QA-02`](../../../../spec/lastenheft.md#lh-qa-02--reproduzierbarkeit), [`ADR-0031`](../../adr/0031-regierende-fassung-und-ort-der-zielstand-setzung.md) |
| [slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) | Das Beobachtungs-Register läuft in der Verzeichnis-Form | [`LH-QA-02`](../../../../spec/lastenheft.md#lh-qa-02--reproduzierbarkeit), [`MR-045`](../../../../harness/conventions.md#mr-045--der-adaptions-block-läuft-in-der-verzeichnis-form) |
| [slice-178](slice-178-regierende-fassung-des-sprungs-v600.md) | Die regierende Fassung dieses Sprungs wird entschieden (Architect) | [`ADR-0031`](../../adr/0031-regierende-fassung-und-ort-der-zielstand-setzung.md), [`ADR-0018`](../../adr/0018-ziel-fassung-regiert-die-migration.md) |
| [slice-179](slice-179-register-ortsfestigkeit-vor-dem-umzug.md) | Die Form des Beobachtungs-Registers wird entschieden — vor dem Umzug (Architect) | [`ADR-0030`](../../adr/0030-eingefrorene-adresse-auf-den-planning-lifecycle.md), [`LH-QA-01`](../../../../spec/lastenheft.md#lh-qa-01--keine-halluzinierten-gates-f4-f5-f6) |
| [slice-182](slice-182-baum-tausch-v600-pins-ziehen.md) | Der vendored Baum steht auf `v6.0.0` — Pins gezogen, Setzung verbucht | [`LH-QA-02`](../../../../spec/lastenheft.md#lh-qa-02--reproduzierbarkeit), [`MR-007`](../../../../harness/conventions.md#mr-007--baseline-committet-vendored-statt-gefetchter-cache), [`ADR-0031`](../../adr/0031-regierende-fassung-und-ort-der-zielstand-setzung.md) |
| [slice-184](slice-184-register-form-im-bestand-nachziehen.md) | Die Form-Beschreibung des Beobachtungs-Registers zieht im Bestand nach | [`LH-QA-02`](../../../../spec/lastenheft.md#lh-qa-02--reproduzierbarkeit), [`ADR-0028`](../../adr/0028-anweisungssatz-gehoert-der-ausfuehrenden-rolle.md), [`ADR-0034`](../../adr/0034-register-verzeichnis-form-und-die-ortsfestigkeit-der-register-datei.md) |
| [slice-185](slice-185-adaptions-durchgang-gegen-v600.md) | Der Adaptions-Durchgang gegen `v6.0.0` — jeder Eintrag mit eigenem Ausgang (Architect) | [`ADR-0018`](../../adr/0018-ziel-fassung-regiert-die-migration.md), [`MR-000`](../../../../harness/conventions.md#mr-000--baseline-aussage) |
...
sind darum aus [slice-176](slice-176-inventur-vor-dem-schnitt-v600.md) §9 hervorgegangen und
...
[welle-14](welle-14-re-baseline.md) §4 für zwei ihrer Zeilen führt, und sie ist gemessen statt
vermutet. Der Katalog weist Position **P-02** (*Kennung: `BEO-<NNN>` → `BEO-<KUERZEL>/<slug>`*)
[slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) zu und vermerkt
...
[slice-186](slice-186-beobachtungs-kennungen-loesen-wieder-auf.md) §1). Ein Katalog ordnet
...
[slice-183](../done/slice-183-ausloeser-der-wellenlosen-archivierung.md), der aus demselben Katalog
...
[slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) die Ablage umzieht, weisen
...
in [slice-176](slice-176-inventur-vor-dem-schnitt-v600.md) §9 in einem eigenen Abschnitt
...
[slice-157](slice-157-adaptions-durchgang-v5180.md) in
...
[slice-183](../done/slice-183-ausloeser-der-wellenlosen-archivierung.md) — *Der Auslöser der
...
[welle-14](welle-14-re-baseline.md) §4 für zwei ihrer Zeilen führt. Die Position ist einzeln
...
[slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) §1. Der Katalog weist diese
...
fällen darf.** [slice-178](slice-178-regierende-fassung-des-sprungs-v600.md) löst Übergabe 1
aus §5 ein — die Präzedenz ist derselbe Gegenstand eine Runde früher
([slice-163](slice-163-regierende-fassung-des-sprungs.md), Mitglied von
[welle-14](welle-14-re-baseline.md)).
[slice-179](slice-179-register-ortsfestigkeit-vor-dem-umzug.md) geht Zeile 2 voraus: Die
...
- **Blockiert: eine Kante, und sie hängt an einem Slice statt an dieser Welle.** Der Katalog
  ...
  [slice-092](../next/slice-092-traeger-inventur.md), [`MR-040`](../../../../harness/conventions.md#mr-040--drei-ausgänge-für-eine-präsens-aussage-über-den-vendored-baum)).
  ...
  **[slice-182](slice-182-baum-tausch-v600-pins-ziehen.md) blockiert
  [slice-091](../next/slice-091-vendored-baum-ohne-anspruch.md),
  [slice-092](../next/slice-092-traeger-inventur.md) und
...
- **Zwei Übergaben an den Architect** stehen in
  ...
  [slice-178](slice-178-regierende-fassung-des-sprungs-v600.md) auf der zweistufigen
  Messung in jenem §9. Übergabe 2 — die **Buchung der Zielstand-Setzung** nach
  [`ADR-0031`](../../adr/0031-regierende-fassung-und-ort-der-zielstand-setzung.md) Festlegung 2 —
  trägt [slice-182](slice-182-baum-tausch-v600-pins-ziehen.md) als dessen dritter
...
- **Eine dritte Übergabe ist mit dem Katalog entstanden und liegt außerhalb dieser Welle:** der
  **Auslöser der wellenlosen Zeitdokumente-Archivierung**
  ([slice-183](../done/slice-183-ausloeser-der-wellenlosen-archivierung.md), Position P-06). Zwei
...
- **Vier Kanten innerhalb der Welle sind tragend, eine ist ordnend.** Tragend:
  ...
  [slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) — ohne die entschiedene
  ...
  [slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) — die Vorlage, aus der die
  ...
  [slice-184](slice-184-register-form-im-bestand-nachziehen.md) — der Ziel-Wortlaut, den der
  Bestand übernimmt, entsteht dort.
  [slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) →
  [slice-186](slice-186-beobachtungs-kennungen-loesen-wieder-auf.md) — die vierte tragende
  Kante, und sie trägt aus einem anderen Grund als die dritte: Die Plan-Datei von
  [slice-177](slice-177-beobachtungs-register-verzeichnis-form.md) ist selbst eines der
  ...
  [slice-176](slice-176-inventur-vor-dem-schnitt-v600.md) →
  [slice-178](slice-178-regierende-fassung-des-sprungs-v600.md), weil die Wahl auf der
...
- **Der d-check-Pin** ([slice-135](../next/slice-135-d-check-pin-v0661.md)) — eigene Linie, eigener
...
[slice-183](../done/slice-183-ausloeser-der-wellenlosen-archivierung.md)) und Verweise auf
