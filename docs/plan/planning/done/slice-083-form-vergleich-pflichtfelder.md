...
| [`spec/spezifikation.md`](../../../../spec/spezifikation.md) | **neues Pflichtfeld** | jede Tabelle in §2–§6 gewinnt eine `ID`-Spalte mit `SPEC-<NNN>` (fortlaufend über die Datei), §7 verliert die `ADR`-Spalte (Decken-Regel: kein ADR-Bezug in einem Spec-Stratum) — **ausgegliedert in [slice-147](../done/slice-147-spezifikation-traegt-ihr-id-schema.md)**, siehe §6 |
| [`spec/architecture.md`](../../../../spec/architecture.md) | **neues Pflichtfeld** | §1 vergibt `ARC-<NNN>` je Komponente, §2 referenziert sie in einer neuen Spalte, §3 vergibt `ARC-<NNN>` je externer Abhängigkeit — **ausgegliedert in [slice-148](../done/slice-148-architecture-traegt-ihr-id-schema.md)**, siehe §6 |
...
- [x] Der Form-Diff ist gefahren und je **ausgefülltem Artefakt dieser Ebene** mit Ausgang
      ...
      **sechstes** Feld `klasse`, das der Skill nicht hat. **Der Zuschnitt ist korrigiert, nicht
      gewachsen:** [slice-085](../in-progress/slice-085-emittierte-ebene-zieht-nach.md) führte den Skill in §3, und
...
| [`spec/spezifikation.md`](../../../../spec/spezifikation.md) | update | `SPEC-<NNN>`-Spalte je Tabelle §2–§6, `ADR`-Spalte in §7 entfällt | **ausgegliedert** — [slice-147](../done/slice-147-spezifikation-traegt-ihr-id-schema.md) |
| [`spec/architecture.md`](../../../../spec/architecture.md) | update | `ARC-<NNN>` je Komponente (§1) und externer Abhängigkeit (§3), Schichten-Tabelle referenziert (§2) | **ausgegliedert** — [slice-148](../done/slice-148-architecture-traegt-ihr-id-schema.md) |
...
[slice-085](../in-progress/slice-085-emittierte-ebene-zieht-nach.md) — zwei Ebenen, zwei Verträge.
...
[slice-147](../done/slice-147-spezifikation-traegt-ihr-id-schema.md) (**23** lebende
Referenzstellen) und [slice-148](../done/slice-148-architecture-traegt-ihr-id-schema.md) (**2**),
...
- **Zwei weitere schwere Posten, vom ursprünglichen Schnitt nicht vorgesehen: die `ID`-Schemata von
  ...
  zwei eigene Slices beim Re-Schnitt vom 2026-08-31** (§4): [slice-147](../done/slice-147-spezifikation-traegt-ihr-id-schema.md)
  für `spec/spezifikation.md` (**23** lebende Referenzstellen, gemessen dort §1), [slice-148](../done/slice-148-architecture-traegt-ihr-id-schema.md)
