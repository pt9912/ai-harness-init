...
- [x] Der Form-Diff ist gefahren und je **ausgefülltem Artefakt dieser Ebene** mit Ausgang
      ...
      **sechstes** Feld `klasse`, das der Skill nicht hat. **Der Zuschnitt ist korrigiert, nicht
      gewachsen:** [slice-085](../done/slice-085-emittierte-ebene-zieht-nach.md) führte den Skill in §3, und
...
[slice-085](../done/slice-085-emittierte-ebene-zieht-nach.md) — zwei Ebenen, zwei Verträge.
