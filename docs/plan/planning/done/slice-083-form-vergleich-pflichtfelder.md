...
| [`spec/architecture.md`](../../../../spec/architecture.md) | **neues Pflichtfeld** | §1 vergibt `ARC-<NNN>` je Komponente, §2 referenziert sie in einer neuen Spalte, §3 vergibt `ARC-<NNN>` je externer Abhängigkeit — **ausgegliedert in [slice-148](../next/slice-148-architecture-traegt-ihr-id-schema.md)**, siehe §6 |
...
| [`spec/architecture.md`](../../../../spec/architecture.md) | update | `ARC-<NNN>` je Komponente (§1) und externer Abhängigkeit (§3), Schichten-Tabelle referenziert (§2) | **ausgegliedert** — [slice-148](../next/slice-148-architecture-traegt-ihr-id-schema.md) |
...
Referenzstellen) und [slice-148](../next/slice-148-architecture-traegt-ihr-id-schema.md) (**2**),
...
- **Zwei weitere schwere Posten, vom ursprünglichen Schnitt nicht vorgesehen: die `ID`-Schemata von
  ...
  für `spec/spezifikation.md` (**23** lebende Referenzstellen, gemessen dort §1), [slice-148](../next/slice-148-architecture-traegt-ihr-id-schema.md)
...
- **Folge-Slices:** neu aus dieser Closure ist
  ...
  [slice-148](../next/slice-148-architecture-traegt-ihr-id-schema.md) in `open/`; sie sind nicht
