...
- **Zwei Einträge sind am adoptierten Stand kein Delta mehr, und der Ausgang gehört nicht in ihr
  ...
  eingetreten** → [slice-150](../in-progress/slice-150-drei-eintraege-tragen-den-adoptierten-stand.md),
...
- **Ein Adaptions-Absatz misst gegen den abgelösten Tag und liest sich dadurch falsch herum.**
  ...
  *„keine Abweichung von einer Baseline-Regel"*; gegen `v5.12.0` gemessen ist es eine —
  ...
  [slice-150](../in-progress/slice-150-drei-eintraege-tragen-den-adoptierten-stand.md), Liefer-Punkt 3.
...
- **Steering-Loop-Eintrag: eine geschärfte Regel, verkörpert.** *Ein fehlendes Pflichtfeld wird
  ...
  Liefer-Punkt 3 von [slice-150](../in-progress/slice-150-drei-eintraege-tragen-den-adoptierten-stand.md)
...
- **Folge-Slices:** neu aus dieser Closure ist
  [slice-150](../in-progress/slice-150-drei-eintraege-tragen-den-adoptierten-stand.md) — *Drei
...
- **Risiken aus §6:** acht benannt
  ...
  [slice-150](../in-progress/slice-150-drei-eintraege-tragen-den-adoptierten-stand.md)), **fünf
