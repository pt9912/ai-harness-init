...
[slice-089](../next/slice-089-carveout-co-002-ueberfuehren.md) sind im selben Planner-Lauf
...
- **Der Eintritts-Move braucht denselben Link-Zug wie der Move nach `done/`.** §5 schreibt ihn nur
  ...
  [slice-088](slice-088-dcheck-pin-v0620.md) und
  [slice-089](../next/slice-089-carveout-co-002-ueberfuehren.md) nennt §5 den Link-Zug für **beide**
...
| Die Folgepflichten 1–5 der ADR (Carveout nach `done/`, sechs Zeiger, zwei Matrix-Zellen, Audit-Gegenstand, Mutations-Fall) | [slice-089](../next/slice-089-carveout-co-002-ueberfuehren.md) — geschnitten, Eintritt hängt an *Accepted* |
