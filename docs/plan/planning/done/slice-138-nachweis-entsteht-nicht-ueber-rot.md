...
[slice-137](../in-progress/slice-137-beobachtungs-register-bekommt-seinen-ort.md) als zwei Konjunkte
...
- [x] Beobachtungs-Register fortgeschrieben — **falls es zum
      ...
      [slice-137](../in-progress/slice-137-beobachtungs-register-bekommt-seinen-ort.md), und die
...
[slice-137](../in-progress/slice-137-beobachtungs-register-bekommt-seinen-ort.md) — der Slice, der es erst
...
[slice-137](../in-progress/slice-137-beobachtungs-register-bekommt-seinen-ort.md). Läuft dieser Slice
