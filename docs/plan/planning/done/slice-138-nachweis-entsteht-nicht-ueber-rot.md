...
[slice-137](../done/slice-137-beobachtungs-register-bekommt-seinen-ort.md) als zwei Konjunkte
...
- [x] Beobachtungs-Register fortgeschrieben — **falls es zum
      ...
      [slice-137](../done/slice-137-beobachtungs-register-bekommt-seinen-ort.md), und die
...
- **Der Ergebnis-Nachweis bleibt ungebaut.** Keine der drei gemessenen Mechaniken liest, **ob** die
  ...
  [slice-137](../done/slice-137-beobachtungs-register-bekommt-seinen-ort.md).
...
[slice-137](../done/slice-137-beobachtungs-register-bekommt-seinen-ort.md) — der Slice, der es erst
...
| `make mutate` nicht herstellbar | Verifikation `V-1` | **entschieden: Haken mit benanntem Ersatz**, Lauf weiter offen mit Träger [slice-130](../done/slice-130-emitter-entscheidet-jedes-neue-template.md) (*Der Haken zu (3)*) |
...
[slice-137](../done/slice-137-beobachtungs-register-bekommt-seinen-ort.md). Läuft dieser Slice
