...
- **Die Bezugsmenge ist ein `grep` und keine Vollständigkeitsaussage** (`BEO-025`, 2×). Die zwei
  ...
  **Ausgang: eingetreten →**
  [slice-188](../done/slice-188-archiv-stub-kennt-die-register-verzeichnis-form.md). Zweimal
...
- **Folge-Slices:**
  [slice-188](../done/slice-188-archiv-stub-kennt-die-register-verzeichnis-form.md) (*Der
