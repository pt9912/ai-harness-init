...
[slice-186](../next/slice-186-beobachtungs-kennungen-loesen-wieder-auf.md) zieht die **Identität** einer
...
- **Die Bezugsmenge ist ein `grep` und keine Vollständigkeitsaussage** (`BEO-025`, 2×). Die zwei
  ...
  **3**, während [slice-186](../next/slice-186-beobachtungs-kennungen-loesen-wieder-auf.md) über
