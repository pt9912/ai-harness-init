...
- **Die `[haenger]`-Sperre und die Norm-Frage dahinter** — ein anderer Vorgang mit eigener
  ...
  [slice-216](../done/slice-216-verweise-auf-review-reports-bekommen-ihren-ausgang.md), und eine
...
[slice-216](../done/slice-216-verweise-auf-review-reports-bekommen-ihren-ausgang.md): Er macht eine
