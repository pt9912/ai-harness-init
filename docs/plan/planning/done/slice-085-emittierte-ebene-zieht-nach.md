...
- **Die emittierte Starter-Config bleibt bewusst schmaler als der Dogfood.** Ihre Modul-Liste
  ...
  [slice-073](../next/slice-073-emittierte-doc-gate-module.md) in `open/`; wer sie hier mitnimmt, vermischt
...
- **Folge-Slices:** keine. Die emittierte Doc-Gate-Modul-Liste bleibt bei
  [slice-073](../next/slice-073-emittierte-doc-gate-module.md) in `open/`.
