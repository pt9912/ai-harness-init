...
[slice-099](../next/slice-099-leser-und-aufraeum-kommando.md).
...
frei. **Nicht Trigger:** [slice-099](../next/slice-099-leser-und-aufraeum-kommando.md) — die beiden hängen
...
- **Das Dokument ist im Ziel ein Waise.** Nichts verweist auf es — selbst gemessen am Probe-Ziel
  ...
  [slice-099](../next/slice-099-leser-und-aufraeum-kommando.md), wo Leser und Aufräum-Kommando
  zusammenkommen.
