...
| Die sechs kanonischen Rollen-Namen stehen an **vier** Produktions-Fundorten, und der vierte wird als **erster ins Ziel emittiert** | **[slice-104](../in-progress/slice-104-rollen-namen-haben-eine-quelle.md)** — nachgezogen: §1 beziffert jetzt vier, die Tabelle führt den neuen Fundort, §3 bekommt seine Zeile und **Frage C** (in welcher Form er ableitet — er ändert die Bytes einer Adopter-Datei). Die Kriterien sind **unverändert**: DoD (1) verlangt weiterhin die Zahl **1** |
...
[slice-104](../in-progress/slice-104-rollen-namen-haben-eine-quelle.md) §Die Grenze für die Test-Tabelle
...
[slice-104](../in-progress/slice-104-rollen-namen-haben-eine-quelle.md) dessen Gegenstand vom *Satz der
