...
- **Wächter ohne Fall — die größte Klasse.** Acht der fünfzehn neuen Go-Wächter aus
  ...
  [slice-104](../next/slice-104-rollen-namen-haben-eine-quelle.md),
...
- **Vier Produktions-Fundorte für sechs Rollen-Namen, und der vierte geht als erster ins Ziel.**
  ...
  nicht geschlossen. Träger: [slice-104](../next/slice-104-rollen-namen-haben-eine-quelle.md).
...
- **Das Werkzeug, das die Belege liefert, ist teurer geworden — an dieser Closure gemessen.**
  ...
  [slice-105](../done/slice-105-mutate-messen-dann-teilen.md) — **erst messen, dann teilen** — und
...
| [slice-104](../next/slice-104-rollen-namen-haben-eine-quelle.md) | die Rollen-Namen haben eine Quelle statt vier Fundorte |
