...
- **Das Werkzeug, das die Belege liefert, ist teurer geworden — an dieser Closure gemessen.**
  ...
  [slice-105](../open/slice-105-mutate-messen-dann-teilen.md) — **erst messen, dann teilen** — und
  [slice-106](../in-progress/slice-106-rotes-ci-traegt-seinen-ausgang.md) für das Rot der CI, das heute
...
| [slice-105](../open/slice-105-mutate-messen-dann-teilen.md) | `make mutate` wird erst gemessen, dann geteilt |
| [slice-106](../in-progress/slice-106-rotes-ci-traegt-seinen-ausgang.md) | jedes Rot der CI trägt einen Ausgang |
