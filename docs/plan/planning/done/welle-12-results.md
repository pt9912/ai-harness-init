...
- **Das Werkzeug, das die Belege liefert, ist teurer geworden — an dieser Closure gemessen.**
  ...
  [slice-106](../next/slice-106-rotes-ci-traegt-seinen-ausgang.md) für das Rot der CI, das heute
...
| [slice-106](../next/slice-106-rotes-ci-traegt-seinen-ausgang.md) | jedes Rot der CI trägt einen Ausgang |
