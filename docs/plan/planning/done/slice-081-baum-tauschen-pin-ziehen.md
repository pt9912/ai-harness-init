...
- [x] **Jeder rote Sensor dieses Slice trägt einen benannten Ausgang — Carveout *oder* Slice —,
      ...
      2. **`make smoke` / `make full-smoke`** — **10** Befunde im emittierten Baum, gemessen und
         ...
         [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md) §1). Zugeordnet
         sind sie zwei Slices derselben Welle: **7** an
         [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md), **3** an
      ...
      4. **`make mutate` — rot, und nicht teilweise: er läuft gar nicht.** Der Treiber fährt vor
         ...
         **Sein Ausgang ist kein eigener, und genau das ist die Feststellung:** dieser Sensor hat
         ...
         Slices zugeordnet — [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md)
...
- **Der vendored Baum ist zugleich die Eingabe des Emissions-Kanals, und der trägt eine
  ...
  **Dieses Risiko stand vor dem Lauf nicht hier** — der Plan hat den Baum als Verweis-Ziel und als
  ...
  [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md) §1): **7** Befunde →
  [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md), **3** →
  [slice-130](../open/slice-130-emitter-entscheidet-jedes-neue-template.md).
- **Der einzige Sensor dieser Klasse liegt außerhalb von `make gates`, und das steht seit
  ...
  **innerhalb** der Gates baubar ist, entscheidet
  [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md) §2 (3).
- **Ein roter Sensor kann einen zweiten mitreißen, und der zweite sieht dann gar nichts mehr.**
  ...
  [slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md) und
...
([slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md)) —, **3** aus zweien der
...
[slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md) (zweimal davon zusammen
...
[slice-133](../in-progress/slice-133-emittierter-baum-ohne-platzhalter-links.md) (sieben der zehn
