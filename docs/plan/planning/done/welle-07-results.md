...
- **`make mutate` war die Reibungsquelle der Welle** (F-12): es mutiert den **Host**-Baum, blockiert
  ...
  ist als [slice-047](../open/slice-047-mutate-host-isolation.md) geschnitten, aber bewusst **nicht**
  Teil dieser Welle.
...
- **[slice-047](../open/slice-047-mutate-host-isolation.md)** (`open/`, ohne Welle): `make mutate`
