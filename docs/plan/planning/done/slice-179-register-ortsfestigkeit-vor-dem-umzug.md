...
[slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md), dessen Vorbedingung er
...
- [x] Doku-Update: der ADR-Index ([`docs/plan/adr/README.md`](../../adr/README.md)) trägt die neue
      ...
      [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) §2 nennt die
...
| [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) §2 | update | die DoD nennt danach die entschiedene Gestalt |

Der Umzug selbst steht **nicht** in dieser Liste: Er ist der Gegenstand von
[slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md), und die Entscheidung geht
ihm voraus.
...
- `in-progress` → `open` (blockiert — Carveout?): wenn der Katalog aus
  [slice-176](../done/slice-176-inventur-vor-dem-schnitt-v600.md) §9 die Register-Position anders
...
- **Folge-Slices:** keiner neu. Die Arbeit, die aus dieser Entscheidung folgt, hat ihre Dateien
  bereits — [slice-177](../next/slice-177-beobachtungs-register-verzeichnis-form.md) vollzieht den
