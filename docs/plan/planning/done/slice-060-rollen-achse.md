...
| die Rechnung über den erfassten Werten (Bilanz, Cache-Zähler, Abdeckungszahl) | [slice-066](../open/slice-066-telemetrie-auswertung.md) · [slice-071](../open/slice-071-cache-zaehler-getrennt.md) · [slice-068](../in-progress/slice-068-rollen-arbeit-laeuft-als-rolle.md) |
