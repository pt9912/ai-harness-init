...
| die Rechnung über den erfassten Werten (Bilanz, Cache-Zähler, Abdeckungszahl) | [slice-066](slice-066-telemetrie-auswertung.md) · [slice-071](../next/slice-071-bilanz-nennt-ihren-bestand.md) · [slice-068](slice-068-rollen-arbeit-laeuft-als-rolle.md) |
