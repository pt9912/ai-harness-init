...
- **Ein Vor-Commit-Sensor kann umgangen werden, und das ist keine Ausrede, sondern eine Grenze.**
  ...
  — **Ausgang: eingetreten →
  [slice-215](../in-progress/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md).** Es ist
...
- **Zwei Läufe über denselben Gegenstand driften.** Läuft der Check vor dem Commit **und** über
  ...
  [slice-215](../in-progress/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md), statt hier
...
- **Folge-Slices: einer.**
  [slice-215](../in-progress/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md) — *Der
  ...
  [slice-215](../in-progress/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md) §1
...
- **Risiken aus §6:** vier Risiken, vier Ausgänge — **eines *eingetreten*** (der umgehbare
  Vor-Commit-Sensor → [slice-215](../in-progress/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md))
...
- **Drei Paarungen:** **nicht dieser Closure geschuldet** — im Repo **mit** Wellen-Betrieb trägt sie
  ...
  **(b) Folge-Slice** — [slice-215](../in-progress/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md)
