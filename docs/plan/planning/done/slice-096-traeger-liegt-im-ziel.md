...
[slice-098](../next/slice-098-feldliste-ist-ausdruck-des-traegers.md) mit),
...
- [x] **(3) Anwesenheits-Wächter für Träger und Wrapper — die Bedingung steht im Wächter, nicht in
      ...
      **Der Sensor misst die Adresse, der Gegenstand ist die Aussage — darum die Aussagen-Menge,
      ...
      Zweig des Trägers, [slice-098](../next/slice-098-feldliste-ist-ausdruck-des-traegers.md)) — sie
...
- **Von Folgepflicht 6 ist die Hälfte eingelöst, nicht die ganze.** Die Fitness-Function-Zeile
  ...
  [slice-097](../done/slice-097-rollen-typen-gehen-mit.md) und
  [slice-098](../next/slice-098-feldliste-ist-ausdruck-des-traegers.md); §Bezug trägt die Teilung
...
- **Ein frischer Klon des Adopter-Repos erfasst still nichts.** Der Träger liegt gitignored; ein
  ...
  ([slice-099](../open/slice-099-leser-und-aufraeum-kommando.md)), nicht beim Schreiber.
...
| *„`make gates` des Ziels ist grün"* ist im Fehlerzweig argumentiert, nicht gelaufen | **[slice-098](../next/slice-098-feldliste-ist-ausdruck-des-traegers.md)** — seine §3-Zeile zu [`harness/tools/full-smoke.sh`](../../../../harness/tools/full-smoke.sh) nennt *„beide Varianten, beide Zweige"*; dahinter steht der Closure-Trigger von [welle-12](../welle-12-erfassungsschicht-emittieren.md), der das frische Ziel **in beiden Zweigen** grün sehen will |
...
an [slice-098](../next/slice-098-feldliste-ist-ausdruck-des-traegers.md):** jener trägt bereits
