...
[slice-073](../in-progress/slice-073-emittierte-doc-gate-module.md): reaktiv, aus einer Messung am Bestand.
...
- **Was dieser Slice ausdrücklich NICHT tut.** Die Doc-Gate-Konfiguration im Ziel (der
  ...
  [slice-073](../in-progress/slice-073-emittierte-doc-gate-module.md) — **dieselbe Klasse Befund** (eine
  ...
  [slice-073](../in-progress/slice-073-emittierte-doc-gate-module.md) DoD (3) fällt hier also NICHT** — wer das
