...
[slice-174](../in-progress/slice-174-archivierung-emittieren.md), nicht
...
- **Zwei Fäden, deren Träger nicht diese Closure ist, und beide sind benannt statt still.**
  ...
  [slice-174](../in-progress/slice-174-archivierung-emittieren.md) DoD (2). Sein Start-Trigger nennt
