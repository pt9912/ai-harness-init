...
- `in-progress` → `open` (blockiert — Carveout?): wenn die Frage *gehört die Stub-Form überhaupt
  ...
  [slice-158](../done/slice-158-archivierungs-schritt.md) für die Dogfood-Ebene, und ohne dessen Verdikt
...
- **Die Entscheidung hängt an [slice-158](../done/slice-158-archivierungs-schritt.md)** und kann ins Leere
