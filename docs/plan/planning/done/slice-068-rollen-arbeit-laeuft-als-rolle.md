...
- **Kein Zahn, und der Grund ist der Gegenstand.** Zugesagt ist eine Aussage darüber, was
  ...
  [slice-066](slice-066-telemetrie-auswertung.md): fällt der Sammelposten-Anteil aus dem
...
| Ein gehobener Sammelposten-Anteil belegt keinen Bruch — die Zahl trägt beide Fälle. Wer sie druckt, sagt das dazu | [slice-066](slice-066-telemetrie-auswertung.md) DoD (1), wo die Größe entsteht |
| Zwei Textmängel in Rang 2: die Historie-Zeile zählt den Inhalt von §5 auf, ohne die DASS-Regel und die Berichtsgröße zu nennen; im bindenden Absatz zeigen *er* und *seiner* auf ein Substantiv (*der Bruch*), das im Dokument nicht steht | die nächste Änderung an §5 — geplant ist [slice-066](slice-066-telemetrie-auswertung.md) DoD (3). Keine Wirkung auf eine DoD, kein Gate greift |
