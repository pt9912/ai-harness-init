...
| `internal/emit/templates/commands/`, `.harness/skills/` | **unverändert** | der **Text** der emittierten Artefakte ist Gegenstand von [slice-085](../next/slice-085-emittierte-ebene-zieht-nach.md); hier geht es um die **Menge** |
