...
- [x] `make gates` grün — **ohne** die Ausnahme aus
      ...
      **Der Haken ruht auf der Ausnahme-Hälfte, nicht auf dem Wort *grün*:** `make -k gates` ist
      ...
      ([slice-132](../done/slice-132-adaptions-block-ohne-totes-ziel.md)), den dieser Slice nicht
...
- **[`LH-FA-02`](../../../../spec/lastenheft.md#lh-fa-02--zweiklassige-template-ablage-f3) zählt
  ...
  [slice-139](../done/slice-139-lastenheft-deckt-die-emit-disposition.md) — als Change Request,
...
[slice-132](../done/slice-132-adaptions-block-ohne-totes-ziel.md) in `open/` liegt. Ein Slice, der
...
([`MR-015`](../../../../harness/conventions.md#mr-015--change-request-bei-personalunion-von-auftraggeber-und-entwickler)),
sein Träger [slice-139](../done/slice-139-lastenheft-deckt-die-emit-disposition.md). Der gesamte
...
[slice-137](../done/slice-137-beobachtungs-register-bekommt-seinen-ort.md). **Die Folge ist nicht
...
([slice-139](../done/slice-139-lastenheft-deckt-die-emit-disposition.md)), nicht durch Zurücklegen
...
[slice-132](../done/slice-132-adaptions-block-ohne-totes-ziel.md) getragen, nicht von hier. Die
...
| Vier Posten stehen nur in Commit-Messages | Review 1 `MEDIUM-3`, Review 2 `MEDIUM-3` | **erledigt** in `7ce375a` — zwei lebende Träger: [slice-139](../done/slice-139-lastenheft-deckt-die-emit-disposition.md) und [slice-140](../done/slice-140-emittierter-stand-ohne-vorlagen-hilfen.md) |
...
| Das emittierte `observations.md` trägt zwei `BEDIENHINWEIS`-Blöcke, die von sich selbst sagen, sie fielen beim Kopieren weg | Review 1 `LOW-2` | **erledigt** in `7ce375a` — Träger [slice-140](../done/slice-140-emittierter-stand-ohne-vorlagen-hilfen.md); gate-neutral (HTML-Kommentar, kein Link) |
...
[slice-139](../done/slice-139-lastenheft-deckt-die-emit-disposition.md) (Lastenheft deckt die
Emit-Disposition — Change Request nach
[`MR-015`](../../../../harness/conventions.md#mr-015--change-request-bei-personalunion-von-auftraggeber-und-entwickler),
trägt zugleich [`ADR-0020`](../../adr/0020-emittierte-modul-15-regeln.md)) und
[slice-140](../done/slice-140-emittierter-stand-ohne-vorlagen-hilfen.md) (der emittierte Stand ohne
...
[slice-132](../done/slice-132-adaptions-block-ohne-totes-ziel.md). `make mutate` ist **nicht**
