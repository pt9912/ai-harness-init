...
| Vier Posten stehen nur in Commit-Messages | Review 1 `MEDIUM-3`, Review 2 `MEDIUM-3` | **erledigt** in `7ce375a` — zwei lebende Träger: [slice-139](../open/slice-139-lastenheft-deckt-die-emit-disposition.md) und [slice-140](../in-progress/slice-140-emittierter-stand-ohne-vorlagen-hilfen.md) |
...
| Das emittierte `observations.md` trägt zwei `BEDIENHINWEIS`-Blöcke, die von sich selbst sagen, sie fielen beim Kopieren weg | Review 1 `LOW-2` | **erledigt** in `7ce375a` — Träger [slice-140](../in-progress/slice-140-emittierter-stand-ohne-vorlagen-hilfen.md); gate-neutral (HTML-Kommentar, kein Link) |
...
[slice-140](../in-progress/slice-140-emittierter-stand-ohne-vorlagen-hilfen.md) (der emittierte Stand ohne
