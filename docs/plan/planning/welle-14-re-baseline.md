...
| [slice-169](in-progress/slice-169-agents-37-messstaende-gegen-v5180.md) | Die vier Mess-Stände in `AGENTS.md` §3.7 stehen gegen `v5.18.0` | [`MR-040`](../../../harness/conventions.md#mr-040--drei-ausgänge-für-eine-präsens-aussage-über-den-vendored-baum), [`AGENTS.md`](../../../AGENTS.md) §3.8 |
