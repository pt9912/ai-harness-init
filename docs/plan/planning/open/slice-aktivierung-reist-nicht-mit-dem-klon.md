...
[slice-commit-traeger-wird-skip-if-present](../next/slice-commit-traeger-wird-skip-if-present.md) führt
...
- **Risiko 2 — die Abbruch-Meldung des Fragments ist fremd.** Gelesen wird der **Pfad**, den die
  ...
  [slice-commit-traeger-wird-skip-if-present](../next/slice-commit-traeger-wird-skip-if-present.md) zieht
