...
[slice-173](../next/slice-173-archive-welle-als-unterkommando.md) gefundenen Verweise, explizites
...
- [ ] **Beide Stub-Arten entstehen aus der vendored Vorlage, und ohne sie bricht der Lauf ab** —
      ...
      [slice-173](../next/slice-173-archive-welle-als-unterkommando.md) ist Folgepflicht 1 jener
      ADR damit erfüllt.
...
[slice-173](../next/slice-173-archive-welle-als-unterkommando.md) liegt in `done/` — vorher gibt
...
[slice-173](../next/slice-173-archive-welle-als-unterkommando.md).** Dessen §4 nennt heute noch
