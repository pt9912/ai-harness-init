...
- [`internal/report/report.go`](../../../../internal/report/report.go) liest den Bestand mit
  ...
  [`cmd/span-report/main.go`](../../../../cmd/span-report/main.go) endet über den Erfolgs-Zweig.
...
- [ ] **(1) Ein nicht existierender Ablageort ist an der Ausgabe von einem leeren zu
      ...
      **Rot:** ein Go-Test über [`internal/report`](../../../../internal/report/report.go) und
      [`cmd/span-report`](../../../../cmd/span-report/main.go) mit einem Pfad, den es nicht gibt —
...
| [`cmd/span-report/main.go`](../../../../cmd/span-report/main.go) | update | der Ablageort kommt hier als Argument herein; ob die Unterscheidung dort oder im Paket ausgesprochen wird, entscheidet der Zuschnitt (oben) |
