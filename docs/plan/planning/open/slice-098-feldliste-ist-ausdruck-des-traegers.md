...
[slice-096](slice-096-traeger-liegt-im-ziel.md), weil das Dokument **aus** dem Träger erzeugt wird
...
- [ ] **(3) Das Dokument teilt den Zweig des Trägers und liegt im geprüften Bereich der
      ...
      aus [slice-096](slice-096-traeger-liegt-im-ziel.md) DoD (2). Es liegt **nicht** unter
