...
Setzung 2). `BEO-025` ist der **Gegenstand** dieses Slice und steht darum nicht zusätzlich als
Risiko in §6. `BEO-009` ist berührt, aber nicht getroffen: Liefer-Punkt 1 zieht die Zusage im
selben Zug wie den Ausdruck nach — genau der Fall, den jene Klasse offen lässt. `BEO-022` ist
