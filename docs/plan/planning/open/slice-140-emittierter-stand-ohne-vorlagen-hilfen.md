...
- [ ] Beobachtungs-Register: eine `observations.md` unter `docs/plan/planning/` existiert nicht
      ...
      [slice-137](slice-137-beobachtungs-register-bekommt-seinen-ort.md). Bis dahin entfällt das
...
[slice-137](slice-137-beobachtungs-register-bekommt-seinen-ort.md). Keine Treffer, und der Grund ist
