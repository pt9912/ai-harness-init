...
- **Das Referenz-Ventil und der Breiten-Wächter.** Sie sind die *heilende* Hälfte derselben
  ...
  als [slice-197](../done/slice-197-eingefrorene-baseline-adresse-bekommt-ihr-ventil.md), und diese Kennung
...
[slice-197](../done/slice-197-eingefrorene-baseline-adresse-bekommt-ihr-ventil.md).** Die zwei sind
...
| `fremdes-rollen-artefakt-im-implementations-kontext` | 5× | verkörpert | der Grund, warum diese Hälfte **nicht** in [slice-197](../done/slice-197-eingefrorene-baseline-adresse-bekommt-ihr-ventil.md) liegt — §1 erster Ausschluss |
