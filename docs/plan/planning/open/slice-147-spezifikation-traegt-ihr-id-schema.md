...
entdeckt — der Form-Diff aus [slice-083](../next/slice-083-form-vergleich-pflichtfelder.md) §1
...
- `in-progress` → `next` (zu groß, zurück zur Zerlegung): die Gegenprobe DoD (2) findet mehr als
  ...
  Klasse, die [slice-083](../next/slice-083-form-vergleich-pflichtfelder.md) reißen ließ) — dann
...
- **Die Ripple-Menge (23 Dateien) ist größer als beim Schnitt von
  [slice-083](../next/slice-083-form-vergleich-pflichtfelder.md) angenommen** (dort nur
...
Einordnung wie in [slice-083](../next/slice-083-form-vergleich-pflichtfelder.md) §8 und
