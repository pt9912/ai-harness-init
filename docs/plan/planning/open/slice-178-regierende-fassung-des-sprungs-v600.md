...
[slice-176](../open/slice-176-inventur-vor-dem-schnitt-v600.md) DoD 3; dieser Slice **wählt** auf
...
- [ ] **Die ADR liegt und entscheidet die regierende Fassung dieses Sprungs**, mit dem Grund, der
      *hier* trägt, statt dem von
      ...
      [slice-176](../open/slice-176-inventur-vor-dem-schnitt-v600.md) §9 als Zeiger, statt es zu
...
**Start** (`next` → `in-progress`): [slice-176](../open/slice-176-inventur-vor-dem-schnitt-v600.md)
