...
**Gegenstand liegt bei [slice-187](../in-progress/slice-187-d-check-pin-v0741.md).** Die Ziel-Version `v0.66.1`
...
[slice-187](../in-progress/slice-187-d-check-pin-v0741.md) §6 mit Ausgang.
