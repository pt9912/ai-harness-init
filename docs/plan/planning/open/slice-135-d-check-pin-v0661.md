...
- [ ] `make gates` ohne **neuen** Befund — und der Punkt sagt hier bewusst nicht „grün": der
      ...
      [slice-132](../next/slice-132-adaptions-block-ohne-totes-ziel.md)). Der Punkt bedeutet hier: **kein
...
[slice-132](../next/slice-132-adaptions-block-ohne-totes-ziel.md) — dessen Befund ist unter beiden Digests
