...
[slice-105](../next/slice-105-mutate-messen-dann-teilen.md). Die zwei Slices sind voneinander unabhängig:
...
- **Die Laufzeit des Treibers.** Sie gehört
  [slice-105](../next/slice-105-mutate-messen-dann-teilen.md); hier wird die **Stufe je Fall** begründet,
...
- **Acht Fälle sind acht Läufe mehr in einem Treiber, der ohnehin die teuerste Stufe des Repos
  ...
  [slice-105](../next/slice-105-mutate-messen-dann-teilen.md). Umgekehrt gilt DoD (2): eine teure Stufe
