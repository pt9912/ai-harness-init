...
[slice-094](../in-progress/slice-094-ein-programm-ein-einstiegspunkt.md) und
...
[slice-094](../in-progress/slice-094-ein-programm-ein-einstiegspunkt.md) angehängt bräche sie dessen Schnitt
...
[slice-094](../in-progress/slice-094-ein-programm-ein-einstiegspunkt.md). Und er ist **vor**
...
**`open` → `next`:** [slice-094](../in-progress/slice-094-ein-programm-ein-einstiegspunkt.md) liegt in `done/` —
...
- **Die Messung kann die Entscheidung umstoßen, und das ist ihr Zweck.** Fällt sie negativ aus,
  steht [slice-094](../in-progress/slice-094-ein-programm-ein-einstiegspunkt.md) teilweise zum Rückbau und die
...
- **Der Vergleichspunkt verschwindet mit dem Slice davor.** Nach
  [slice-094](../in-progress/slice-094-ein-programm-ein-einstiegspunkt.md) gibt es den getrennten Emitter nicht
