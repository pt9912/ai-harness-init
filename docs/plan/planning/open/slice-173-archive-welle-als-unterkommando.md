...
[slice-172](slice-172-adr-archivierung-als-unterkommando.md).
...
- [ ] **`ai-harness-init archive-welle` existiert** — Zweig im `main()`-Dispatch neben
      ...
      [slice-172](slice-172-adr-archivierung-als-unterkommando.md) — das Vorbild formatiert den
...
- [ ] **Die drei am Shell-Helfer rot gesehenen Zusagen halten, je einmal rot gesehen** — die
      Abnahme-Kriterien aus [slice-172](slice-172-adr-archivierung-als-unterkommando.md) DoD (2):
...
- [ ] **`make archive-welle` fährt den Träger**, und der Shell-Helfer samt seinem bats-Satz folgt
      Festlegung (b) aus [slice-172](slice-172-adr-archivierung-als-unterkommando.md) — zwei
...
**Start** (`next` → `in-progress`): [slice-172](slice-172-adr-archivierung-als-unterkommando.md)
