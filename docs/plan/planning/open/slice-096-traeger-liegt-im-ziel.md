...
läuft nach [slice-095](../next/slice-095-hook-aufschlag-gemessen.md), weil dessen Ausgang den Träger
...
**`open` → `next`:** [slice-095](../next/slice-095-hook-aufschlag-gemessen.md) liegt in `done/` **und**
