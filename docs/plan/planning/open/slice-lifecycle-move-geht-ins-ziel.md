...
Ausgang ([slice-226](../in-progress/slice-226-implementer-anweisungssatz-zieht-nach.md), §5 der Welle).
...
- **Der Anweisungssatz dieses Repos.** Gegenstand ist die **emittierte** Vorlage; die lokale Fassung
  zieht über [slice-226](../in-progress/slice-226-implementer-anweisungssatz-zieht-nach.md) nach (Dogfood, eigener
...
[slice-226](../in-progress/slice-226-implementer-anweisungssatz-zieht-nach.md) zieht den lokalen Anweisungssatz auf
