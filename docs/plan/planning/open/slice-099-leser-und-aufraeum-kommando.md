...
[slice-096](../in-progress/slice-096-traeger-liegt-im-ziel.md), weil das Fragment auf den Träger zeigt und der
...
- **Ein leerer Bestand und eine Erfassung, die nicht läuft, sehen beim Leser gleich aus.** Ein
  ...
  [slice-096](../in-progress/slice-096-traeger-liegt-im-ziel.md) §6), und der Leser meldet dann dieselbe Leere wie
