...
([slice-098](../in-progress/slice-098-feldliste-ist-ausdruck-des-traegers.md)), das auch dann trägt, wenn niemand
den Leser ruft.
...
frei. **Nicht Trigger:** [slice-098](../in-progress/slice-098-feldliste-ist-ausdruck-des-traegers.md) — die beiden
