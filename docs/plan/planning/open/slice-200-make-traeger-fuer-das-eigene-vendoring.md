...
auf [slice-197](slice-197-eingefrorene-baseline-adresse-bekommt-ihr-ventil.md).
...
- **Der Ort der Ziel-Beschreibung ist offen.** Die Ziel-Fassung `v6.5.0` verlangt für ein Gate,
  ...
  Posten aus
  [slice-193](../in-progress/slice-193-baum-tausch-v650-pins-ziehen.md) §6 §Offene Punkte —, und
