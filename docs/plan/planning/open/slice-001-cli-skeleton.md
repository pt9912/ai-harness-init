...
- [ ] `LH-FA-01` Negative-AC: fehlendes `--lang` → Exit 2 + Usage auf stderr (bats-Test).
- [ ] `LH-FA-01` Boundary-Teil: `--help`/`-h` → Exit 0 + Usage auf stdout (bats-Test).
...
| `test/cli.bats` | neu | Negative-/Boundary-AC von `LH-FA-01` als Test |
