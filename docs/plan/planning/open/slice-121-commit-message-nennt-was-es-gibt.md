...
**Soll nach [slice-126](../in-progress/slice-126-commit-message-traegt-eine-kennung.md) — der Träger ist geteilt,
...
nach [slice-126](../in-progress/slice-126-commit-message-traegt-eine-kennung.md), erbt er einen entschiedenen Ort
...
- **Ein Vor-Commit-Sensor hat in diesem Repo keinen Präzedenzfall — im gepinnten Image aber
  ...
  ([slice-126](../in-progress/slice-126-commit-message-traegt-eine-kennung.md) §1).
