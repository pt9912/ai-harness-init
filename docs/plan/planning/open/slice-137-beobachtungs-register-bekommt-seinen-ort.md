...
mit eigenen Trägern: [slice-130](../next/slice-130-emitter-entscheidet-jedes-neue-template.md) entscheidet
...
2. **Die adoptierbare Hälfte kostet ein fremdes Norm-Artefakt.** Sie wäre ein viertes
   ...
   [slice-132](slice-132-adaptions-block-ohne-totes-ziel.md) abräumen; ihn nachzuziehen ist
