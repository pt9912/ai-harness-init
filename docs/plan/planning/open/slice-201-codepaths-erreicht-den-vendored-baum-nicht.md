...
- **Die drei `ignore-refs`-Einträge für die einfrierenden Bäume.** Sie decken die **Link**-Form und
  ...
  [slice-197](../in-progress/slice-197-eingefrorene-baseline-adresse-bekommt-ihr-ventil.md), und diese Kennung
...
- [ ] **Die Ursache ist gemessen, nicht gelesen.** Ein Sonden-Paar über einer Kopie **außerhalb**
...
- [ ] **Der Ausgang ist gewählt und belegt: Prüfer oder benannte Grenze.**
...
- [ ] **Das Gegenbeispiel ist rot gesehen** ([`AGENTS.md`](../../../../AGENTS.md) §3.6), und **wovon**
...
[slice-197](../in-progress/slice-197-eingefrorene-baseline-adresse-bekommt-ihr-ventil.md).
