...
- slice-005 und slice-024 liegen in `done/`.
- `make gates` grün.
...
| Slice | Titel | Bezug |
|---|---|---|
| [slice-005](in-progress/slice-005-root-readme.md) | Root-README emittieren | [`LH-FA-05`](../../../spec/lastenheft.md#lh-fa-05--root-readme-emittieren-f1-f2), [`LH-FA-01`](../../../spec/lastenheft.md#lh-fa-01--repo-bootstrappen) |
...
- Intern: slice-024 setzt slice-005 voraus — der Smoke prüft den **vollen** Bootstrap
  inklusive README, vorher meldete er über einem unvollständigen Ziel grün.
