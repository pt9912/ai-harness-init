...
| Slice | Titel | Bezug |
|---|---|---|
| [slice-vorlauf-waechter-geht-ins-ziel](open/slice-vorlauf-waechter-geht-ins-ziel.md) | Der Vorlauf-Wächter der zwei history-lesenden Targets geht ins Ziel | [`LH-FA-06`](../../../spec/lastenheft.md#lh-fa-06--durchsetzungsschicht-emittieren) |
...
[slice-174](next/slice-174-archivierung-emittieren.md) lag in `next/` und trägt denselben
...
- **Berührt, aber bindet nicht — die Dogfood-Zwillinge.** Vier offene Slices fassen dieselben
  ...
  [slice-215](open/slice-215-commit-waechter-sieht-auch-die-ungetippten-commits.md) (der **Träger**
