...
- **Berührt, aber bindet nicht — die Dogfood-Zwillinge.** Vier offene Slices fassen dieselben
  ...
  es vorwegzunehmen:
  [slice-226](in-progress/slice-226-implementer-anweisungssatz-zieht-nach.md) (der ausgeführte
...
[slice-226](in-progress/slice-226-implementer-anweisungssatz-zieht-nach.md) tragen ihn auf der
...
zieht die Roadmap-Abschnittsnamen nach, [slice-226](in-progress/slice-226-implementer-anweisungssatz-zieht-nach.md)
