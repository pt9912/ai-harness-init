...
3. `grep -rln 'QUEUE_LOCK_TRIES' test/ | wc -l` liefert **≥ 1** — die zweite, ältere Schranke ist
   ...
   ([slice-117](../planning/open/slice-117-lauf-ohne-ende-faerbt-rot.md) DoD 3).

**Der zweite Ausgang, und er ist gleichwertig:** zeigt die Bemessungs-Frage aus
[slice-117](../planning/open/slice-117-lauf-ohne-ende-faerbt-rot.md) §3 Frage B, dass jede
...
- [ ] Folge-Slice [slice-117](../planning/open/slice-117-lauf-ohne-ende-faerbt-rot.md) geschlossen oder explizit dokumentiert.
