...
1. **Granularität — einzelne Diskrepanz oder Cluster?** *Einzelne.* Die Nachbar-Abweichung 5
   ...
   Carveout-Zahl (`:60-62`). **Denselben Geltungsbereich in diesem Sinn teilen die zwei nicht:**
   Abweichung 5 gilt Hintergrund-Läufen, für die es einen Aufruf samt Payload gibt; diese hier
   gilt dem Haupt-Kontext, den überhaupt kein Aufruf umschließt. Die Folge einer Cluster-Antwort
   wäre die
