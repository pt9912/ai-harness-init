...
- **Neue Artefakte per `cp`** — die Results-Notiz entsteht seit slice-083 per `cp` aus dem vendored
  `.harness/baseline/v6.5.0/templates/docs/plan/planning/welle-results.template.md` und wird danach
...
4. **Schritt 3 — Closure-Notiz `done/<welle-id>-results.md` schreiben** — per `cp` aus
   `.harness/baseline/v6.5.0/templates/docs/plan/planning/welle-results.template.md`, dann
